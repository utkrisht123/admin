...
if(jEvent != null && jEvent.equalsIgnoreCase("enterpress")){
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
		Enter <small> Press Release</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						...
						<a href="enter-press.jsp">Enter Press Release</a>
						<i class="fa fa-angle-right"></i>
					</li>
				</ul>
			...
			<div class="row">
				...
				<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>Enter press Release
							</div>
							<!-- <div class="tools">
							...
							<!-- BEGIN FORM-->
							<form  action="press" id="form_sample_3" class="form-horizontal" method="post">
								<div class="form-body">
									...
									<div class="alert alert-success">
										<button class="close" data-close="alert"></button>
										Press Release Enter successful!
									</div>
									<%} %>
								...
								<div class="form-actions">
									<div class="row">
										...
										<input type="hidden" value="enterpress" name="jEventName">
