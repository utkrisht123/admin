...
<head>
<meta charset="utf-8"/>
<title>VIEW FAQ REVIEW | Admin</title>
...
String question="",answer="",course="",faqType="",date="";
List<com.LiveDemo> list=new ArrayList<com.LiveDemo>();

	jMessage=(String)request.getAttribute("jMessage");
	al=(List<Faq>)request.getAttribute("data");
	list=(List<com.LiveDemo>)request.getAttribute("data2");
	if(!al.isEmpty())
	{
		question=al.get(0).getQuestionName();
		answer=al.get(0).getAnswer();
		course=al.get(0).getCourse();
		faqType=al.get(0).getFaqType();
		date=al.get(0).getDate();
	}
...
<div class="page-sidebar-wrapper">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<h3 class="page-title">
			VIEW FAQ REVIEWS <small> manage</small>
			</h3>
	     <div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="LoginServlet?jEventName=FAQ_Review">View FAQ Reviews</a>
					</li>
				</ul>
					...
					<div class="portlet box green">
						...
						<div class="portlet-body form">
								     ...
								     <div class="form-group">
										 <div  class="col-md-12" style="text-align:left;">
														<div align="left" class="form-group">
															<label class="control-label col-md-2" style="text-align:left;font-weight:bold;font-size:14px;">&nbsp;QUESTION:</label>
															<div class="col-md-10" style="text-align:left">
																<p class="form-control-static"  style="text-align:left;font-weight:bold;font-size:14px;">
																	<%=question %>
																</p>
															</div>
														</div>
															<div class="form-group"  style="text-align:left;">
															<label class="control-label col-md-2"  style="text-align:left;font-weight:bold;font-size:14px;">&nbsp;ANSWER:</label>
										...
										<div class="col-md-12">
														<div class="form-group">
															<label class="control-label col-md-2"  style="text-align:left;font-weight:bold;font-size:14px;">COURSE</label>
													...
													<div class="col-md-12">
														<div class="form-group">
															<label class="control-label col-md-2"  style="text-align:left;font-weight:bold;font-size:14px;">FAQ TYPE:</label>
															<div class="col-md-10" style="text-align:left;font-size:14px;">
																<p class="form-control-static">
																	<%=faqType %>
																</p>
													...
													<div class="col-md-12">
														<div class="form-group">
															<label class="control-label col-md-2" style="text-align:left;font-weight:bold;font-size:14px;">DATE:</label>
															<div class="col-md-10" style="text-align:left;font-size:14px;">
																<p class="form-control-static">
																	<%=date %>
																</p>
							...
							<table class="table table-striped table-bordered table-hover" id="sample_3">
							   	<thead>
							    	<tr>
								  	 <th scope="col" style="text-align:left;font-weight:bold;font-size:14px;">S.No.</th>
								    <th scope="col"style="text-align:left;font-weight:bold;font-size:14px;">IP Address</th>
								    <th scope="col" style="text-align:left;font-weight:bold;font-size:14px;">Review</th>
									<th scope="col" style="text-align:left;font-weight:bold;font-size:14px;">Date</th>
									<th scope="col" style="text-align:left;font-weight:bold;font-size:14px;">Student ID</th>
									<th scope="col" style="text-align:left;font-weight:bold;font-size:14px;">Student Name</th>
									<th scope="col" style="text-align:left;font-weight:bold;font-size:14px;">Student Email</th>
									</tr>
								</thead>
							<tbody>
							<%
