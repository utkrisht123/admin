...
if(jEvent != null && jEvent.equalsIgnoreCase("U_FAQ")){
	jMessage=(String)request.getAttribute("jMessage");
	al=(List<Faq>)request.getAttribute("data");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("Delete_FAQ")){
	jMessage=(String)request.getAttribute("jMessage");
	al=(List<Faq>)request.getAttribute("data");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("V_FAQ")){
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="LoginServlet?jEventName=V_FAQ">View FAQ</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						...
						<div class="table-toolbar">
							...
							<thead>
							<tr>
								<th scope="col">S.No.</th><th scope="col">Question Id</th>
								<th scope="col">Question</th><th scope="col">Answer</th><th scope="col">Course</th><th scope="col">FAQ Type</th>
								<th scope="col">Title</th><th scope="col">Keyword</th><th scope="col">Description</th>
								<th scope="col">Date</th><th scope="col">View Review</th><th scope="col">Edit</th><th scope="col">Delete</th>
							...
							<td><%=i+1 %></td>
							<td><%=al.get(i).getQuestionId() %></td>
							<td><%=al.get(i).getQuestionName() %></td>
							<td><%=al.get(i).getAnswer() %></td>
							<td><%=al.get(i).getCourse() %></td>
							<td><%=al.get(i).getFaqType() %></td>
							<td><%=al.get(i).getTitle() %></td>
							<td><%=al.get(i).getKeyword() %></td>
							<td><%=al.get(i).getDescription() %></td>
							<td><%=al.get(i).getDate() %></td>
							<td><a  href="LoginServlet?jEventName=FAQ_Review&id=<%=al.get(i).getQuestionId() %>">View Reviews</a></td>
							<td><a  href="LoginServlet?jEventName=E_FAQ&id=<%=al.get(i).getQuestionId() %>">Edit</a></td>
							<td><a  href="LoginServlet?jEventName=Delete_FAQ&id=<%=al.get(i).getQuestionId() %>" onclick="return check();">Delete</a></td>
