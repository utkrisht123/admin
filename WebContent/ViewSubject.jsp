...
//System.out.println("jEvent: "+jEvent);
 List<Batch> al=new ArrayList<Batch>();
if(jEvent != null && jEvent.equalsIgnoreCase("G_Subject")){
	al = (List<Batch>)request.getAttribute("data");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("U_Subject")){
	al = (List<Batch>)request.getAttribute("data");
	jMessage = (String)request.getAttribute("jMessage");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("D_Subject")){
	al = (List<Batch>)request.getAttribute("data");
	jMessage = (String)request.getAttribute("jMessage");
}
else
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="LoginServlet?jEventName=G_Subject">View Subject</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Subject
							</div>
						...
						<div id="detail_loading" style="display: none;">
							...
							<tr>
								...
								<th scope="col">Subject Id</th><th scope="col">Subject Name</th><th scope="col">Display Subject Name</th><th scope="col">Subject Description</th><th scope="col">Training</th><th scope="col">Level</th><th scope="col">Category</th><th scope="col">Technology</th><th scope="col">FREE</th><th scope="col">URL</th><th scope="col">DISPLAY</th><th scope="col">Image</th><th scope="col">Project</th><th scope="col">Status</th><th scope="col">Edit</th><th scope="col">Delete</th>
							...
							<td><%=i+1 %></td>
							<td><%=al.get(i).getSubjectId() %></td>
							<td><%=al.get(i).getSubjectName() %></td>
							<td><%=al.get(i).getDisplaySubjectName() %></td>
							<td><%=al.get(i).getSubjectDescription() %></td>
							<td><%=al.get(i).getTraining() %></td>
							<td><%=al.get(i).getLevelName() %></td>
							<td><%=al.get(i).getCategoryName() %></td>
							<td><%=al.get(i).getTechnologyName() %></td>
							
							
							<%
							if(al.get(i).getFree().equalsIgnoreCase("y"))
							{
								%>
								<td>Yes</td>
								<%
							...
							<td><%=al.get(i).getDisplay() %></td>
							<td><%=al.get(i).getImage() %></td>
							<td><%=al.get(i).getProject() %></td>
							<td><%=al.get(i).getStatus() %></td>
						
							<td><a  href="LoginServlet?jEventName=E_Subject&id=<%=al.get(i).getSubjectId() %>">Edit</a></td>
							<td><a  href="LoginServlet?jEventName=D_Subject&id=<%=al.get(i).getSubjectId() %>" onclick="return check();">Delete</a></td>
...
function check()
{
	var c=window.confirm("Are you sure to delete this record?");
	return c;
}
