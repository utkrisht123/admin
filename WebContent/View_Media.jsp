...
<body class="page-header-fixed page-quick-sidebar-over-content ihh" id="records_table">
<%
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="View_Media.jsp">View Media</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Media
							</div>
    					...
    					<div class="table-scrollable">
							...
							Statement ps = con.createStatement();
							   ResultSet resultSet=ps.executeQuery("select * from Media_Entry");
							...
							<td><%=resultSet.getString("MEDIA_NAME") %></td>
							<td><%=resultSet.getString("DESCRIPTION") %></td>
							<% if(resultSet.getString("DISPLAY").equals("y")){%>
							<td>Display</td>
							<%} else{%>
							<td>Not Display</td>
							<%}%>
							<td><%=resultSet.getString("USER") %></td>
							<td><img alt="" class="hide1" src="MediaImage?ID=<%=resultSet.getString("ID")%>" height="42" width="42"/></td>
							<td><%=resultSet.getString("IMAGE_TITLE") %></td>
							<td><%=resultSet.getString("IMAGE_ALT") %></td>
							<td><a  href="Update-Media.jsp?ID=<%=resultSet.getString("ID")%>">Edit</a></td>
							<td><a  href="Delete_Media?ID=<%=resultSet.getString("ID")%>">Delete</a></td>
