...
//System.out.println("jEvent: "+jEvent);
 ...
 if(jEvent != null && jEvent.equalsIgnoreCase("T_Update")){
	jMessage = (String)request.getAttribute("jMessage");
}

else if(jEvent != null && jEvent.equalsIgnoreCase("T_Allot")){
		jMessage = (String)request.getAttribute("jMessage");
	
}
else if(jEvent != null && jEvent.equalsIgnoreCase("T_Delete")){
		jMessage = (String)request.getAttribute("jMessage");
	
}
 List<com.Teacher> list = new ArrayList<com.Teacher>();
 list=c2.viewTeacher();
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="View_Teacher.jsp">View Teacher</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Teacher
							</div>
							<div class="actions">
						...
						<div class="portlet-body">
							...
							<td><a href="T_Allot.jsp?t_id=<%=list.get(i).getTeacherId() %>">Allot</a></td>
							<td><a href="TeacherAction?jEventName=Teacher_Detail&teacher_id=<%=list.get(i).getTeacherId()%>">View</a></td>
