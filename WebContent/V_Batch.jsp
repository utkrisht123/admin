...
else if(jEvent != null && jEvent.equalsIgnoreCase("D_Batch")){
	jMessage=(String)request.getAttribute("jMessage");
	al=(ArrayList<String>)request.getAttribute("data");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("G_Batch")){
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="LoginServlet?jEventName=G_Batch">View Batch</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Batch
							</div>
    					...
    					<div class="table-scrollable">
							...
							{
								%>
								<td><span class="label label-sm label-success">Verified</span></td>
								<%
							}
							else
							{
								%>
									<td><span class="label label-sm label-danger">Not Verified</span></td>
								<%
							}
								%>
							<td><a class='fancybox fancybox.iframe' href="LoginServlet?jEventName=E_Batch&subject_id=<%=s2[0] %>&batch_id=<%=s2[2] %>">Edit</a></td>
							<td><a  href="LoginServlet?jEventName=D_Batch&batch_id=<%=s2[2] %>" onclick="return check();">Delete</a></td>
