		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="ViewSubscribe.jsp">View Subscribe</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box yellow">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Subscriber
							</div>
							<div class="actions">
	...
	var d='',d2='';
	   var handleDateRangePickers = function () {
		   $('#reportrange').daterangepicker({
		     ...
		     var getAllSubscribe=function ()
		     {
		    	 $('#profile_loading').show();
		    	 $.get("ServletAction",
		        	    {
		             	        jEventName: "ViewSubscribe"
		        	    },
		        	    function(data,status){
		        	      //alert("Data: " + data + "\nStatus: " + status);
		        	    	//alert(data);
	 ...
	 $.get("ServletAction",
   	    {
		 			...
		 			email: email,
		 			course: course,
        	        jEventName: "Update_CampaignSubscriber"
   	    },
   	    function(data,status){
