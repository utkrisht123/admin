		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="Time_Conversion.jsp">Time Conversion</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Time Conversion
							</div>
							<div class="tools">
								...
								<div class="form-body">
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-3">
											<input type="text" name="s_date" id="s_date" data-required="1" class="form-control form-control-inline input-medium date-picker" required="required" />
										...
										* </span>
										...
										<div class="col-md-3">
											<div class="input-group">
												<input type="text" class="form-control timepicker timepicker-24" name="time" id="time" >
									...
									<div class="form-group">
										<label class="control-label col-md-3">Select Time Zone <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<select class="form-control select2me" name="zone" id="zone" onchange="ajaxFunction2();">
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<select class="form-control select2me" name="timezone" id="timezone" onchange="ajaxFunction();">
												<option value="">Select Time Zone </option>
													<%
													for (TimeZone timeZone : timeZones) {
   														 //System.out.println(getName(timeZone));	
													%>
												<option value="<%=timeZone.getID() %>"><%=timeZone.getID().replaceAll("_", " ") + " - " + timeZone.getDisplayName() %></option>
												<%
...
function ajaxFunction(){
	 ...
	 // server script.
		...
		var url="convert.jsp?s_date="+s_date+"&time="+t+"&timezone="+timezone;
