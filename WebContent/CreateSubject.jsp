...
ArrayList<String> alTechnology = new ArrayList<String>();
ArrayList<String> alLevel = new ArrayList<String>();
alCategory=c2.getCategory();
alTechnology=c2.getTechnology();
alLevel=c2.getSkillLevel();
String subjectId="",subjectName="",displaySubjectName="",level="",training="",free="",subjectDescription="",category="",technology="",url="",display="",image="",project="",status="";
if(jEvent != null && jEvent.equalsIgnoreCase("C_Subject")){
	jMessage = (String)request.getAttribute("jMessage");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("E_Subject")){
	jMessage = (String)request.getAttribute("jMessage");
	subjectId = (String)request.getAttribute("subjectId");
	subjectName = (String)request.getAttribute("subjectName");
	displaySubjectName = (String)request.getAttribute("displaySubjectName");
	level=(String)request.getAttribute("level");
	training=(String)request.getAttribute("training");
	free=(String)request.getAttribute("free");
	subjectDescription=(String)request.getAttribute("subjectDescription");
	category=(String)request.getAttribute("category");
	technology=(String)request.getAttribute("technology");
...
else if(jEvent != null && jEvent.equalsIgnoreCase("U_Subject")){
	jMessage = (String)request.getAttribute("jMessage");
	subjectId = (String)request.getAttribute("subjectId");
	subjectName = (String)request.getAttribute("subjectName");
	displaySubjectName = (String)request.getAttribute("displaySubjectName");
...
String f1="",f2="",t1="",t2="",d1="",d2="",s1="",s2="",s3="";
if(display.equalsIgnoreCase("n"))
	d2="selected";
else
	d1="selected";
if(training.equalsIgnoreCase("Instructor Led"))
	t2="checked";
else
	t1="checked";
if(free.equalsIgnoreCase("y"))
	f2="checked";
else
	f1="checked";
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="CreateSubject.jsp">Subject</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>Create Subject
							</div>
							...
							<div class="form-body">
									...
									<div class="form-group">
										...
										* </span>
										...
										<% if(jEvent != null && jEvent.equalsIgnoreCase("E_Subject")){%>
										<div class="col-md-4">
											<input type="text" name="name" id="name" data-required="1" value="<%=subjectName %>" class="form-control" required="required" disabled/>
										</div>
										<%}else{%>
										<div class="col-md-4">
											<input type="text" name="name" id="name" data-required="1" value="<%=subjectName %>" class="form-control" required="required" />
										</div>
										<%}%>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Display Subject Name<span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<input type="text" name="display_name" id="display_name" data-required="1" value="<%=displaySubjectName %>" class="form-control" required="required" />
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Subject Description<span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<textarea name="description" class="form-control" rows="3" required="required"><%=subjectDescription %></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Training<span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<label>
											<input type="radio" name="training" id="optionsRadios1" value="Self-Paced" <%=t1 %>> Self-Paced</label>
											<label>
											<input type="radio" name="training" id="optionsRadios2" value="Instructor Led" <%=t2 %>> Instructor Led </label>	
											
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Free<span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<label>
											<input type="radio" name="free" id="optionsRadios1" value="n" <%=f1 %>> No</label>
											<label>
											<input type="radio" name="free" id="optionsRadios2" value="y" <%=f2 %>> yes </label>
											
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Skill Level<span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											...
											{
												String []s=alLevel.get(i).split("abczxy");
												String msg="";
												if(level!=null && level.equalsIgnoreCase(s[1]))
													msg="selected";
													%>
													<option value="<%=s[0]%>" <%=msg %>><%=s[1]%></option>
													<%
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											...
											{
												String []s=alCategory.get(i).split("abczxy");
												String msg="";
												if(category!=null && category.contains(s[1]))
													msg="checked";
												%>
												<label>
												<input type="checkbox" name="category" value="<%=s[0]%>" <%=msg %>> <%=s[1]%> </label>
												<%
											}
												%>
									...
									<div class="form-group">
										<label class="control-label col-md-3">Technology<span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<div class="checkbox-list">
											<%for(int i=0;i<alTechnology.size();i++) 
											{
												String []s=alTechnology.get(i).split("abczxy");
												String msg="";
												//String ss=techMap.get(s[1]);
												
												if(technology!=null && technology.contains(s[1]))
													msg="checked";
												%>
												<label>
												<input type="checkbox" name="technology" value="<%=s[0]%>" <%=msg %>> <%=s[1]%> </label>
												<%
											}
												%>
									...
									<div class="form-group">
										...
										*
										...
										<div class="col-md-4">
											<input type="text" name="url" id="url" data-required="1" value="<%=url %>" class="form-control" required="required" />
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											...
											<option value="y" <%=d1 %>>Yes</option>
											<option value="n" <%=d2 %>>No</option>
											</select>
										</div>
									</div>
									<div class="form-group">
										...
										*
										...
										<div class="col-md-4">
											<input type="text" name="image" id="image" data-required="1" value="<%=image %>" class="form-control" required="required" />
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="project" id="project" value="<%=project %>" class="form-control" />
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											...
											<option value="New" <%=s1 %>>New</option>
											<option value="Coming Soon" <%=s2 %>>Coming Soon</option>
											<option value="" <%=s3 %>>No Status</option>
											</select>
								...
								<div class="form-actions">
									...
									if(jEvent != null && jEvent.equalsIgnoreCase("E_Subject") ){
										...
										<input type="hidden" name="jEventName" value="U_Subject" />
											<input type="hidden" name="id" value="<%=subjectId%>" />
											<input type="hidden" name="name" value="<%=subjectName%>" />
											<input type="hidden" name="old_name" value="<%=subjectName%>" />
										<%
											}
									else
									{
										...
										<input type="hidden" name="jEventName" value="C_Subject" />
										<%
									}
