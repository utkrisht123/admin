...
<div class="page-sidebar-wrapper">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Direct Payment <small>View</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="ViewDirectPayment.jsp">View Direct Payment</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Direct Payment Detail
							</div>
							<div class="actions">
	...
	var d='',d2='';
	   var handleDateRangePickers = function () {
		   $('#reportrange').daterangepicker({
		    	 ...
		    	 $.get("ServletAction",
		        	    {
		             	        ...
		             	        jEventName: "DirectPaymentByFilter"
		        	    },
		        	    function(data,status){
		        	      //alert("Data: " + data + "\nStatus: " + status);
		        	    	//alert(data);
		     ...
		     var getDirect=function ()
		     {
		    	 $('#profile_loading').show();
		    	 $.get("ServletAction",
		        	    {
		             	        jEventName: "ViewDirectPayment"
		        	    },
		        	    function(data,status){
		        	      //alert("Data: " + data + "\nStatus: " + status);
		        	    	//alert(data);
	 ...
	 $.get("ServletAction",
   	    {
		 			...
		 			email: email,
		 			course: course,
        	        jEventName: "Update_CampaignPayment"
   	    },
   	    function(data,status){
