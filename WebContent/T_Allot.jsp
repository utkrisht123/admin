<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
       <jsp:useBean id="c2" class="com.LiveDemoDAO"></jsp:useBean>
        <jsp:useBean id="c" class="com.TeacherDAO"></jsp:useBean>
...
<div class="page-sidebar-wrapper">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Allot Teacher <small> Batch</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="T_Allot.jsp">Allot Teacher</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Allot Teacher Batch
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							...
							<form action="LoginServlet" method="post" id="form_sample_3" class="form-horizontal">
								<div class="form-body">
									...
									if(teacherId==null)
										teacherId="";
									if(jEvent != null && jEvent.equalsIgnoreCase("T_Allot")){
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<select class="form-control select2me" name="teacher_id" id="teacher_id">
											<option value="">Select Teacher</option>
												<%
												ArrayList<String> al=new ArrayList<String>();
												al=c2.getCourse();
												List<com.Teacher> al2=new ArrayList<com.Teacher>();
												al2=c.viewTeacher();
												for(int i=0;i<al2.size();i++)
												{
													String msg="";
													if(teacherId.equals(al2.get(i).getTeacherId()))
														msg="selected";
												%>
												<option value="<%=al2.get(i).getTeacherId() %>" <%=msg %>><%=al2.get(i).getTeacherId()+"-"+al2.get(i).getTeacherName() %></option>
												<%} %>
											</select>
										</div>
									</div>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											...
											<input type="hidden" name="jEventName" value="T_Allot"/>
										</div>
									</div>
								</div>
