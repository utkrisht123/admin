...
<div class="page-sidebar-wrapper">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Student Story <small> View</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="ServletAction?jEventName=ViewFeedback">View Feedback</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Student Story
							</div>
							<div class="actions">
						...
						<div class="portlet-body">
							...
							<%
									...
									for(int i=0;i<list.size();i++)
									{
											...
											String s2[]=list.get(i).split("abczxy");;
								%>
							<tr class="odd gradeX">
