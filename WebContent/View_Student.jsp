...
if(jEvent != null && jEvent.equalsIgnoreCase("V_S_List")){
	jMessage = (String)request.getAttribute("jMessage");
		
}
else if(jEvent != null && jEvent.equalsIgnoreCase("S_Update")){
	jMessage = (String)request.getAttribute("jMessage");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("S_C_Password")){
		jMessage = (String)request.getAttribute("jMessage");
	
}
else if(jEvent != null && jEvent.equalsIgnoreCase("S_Allot")){
		jMessage = (String)request.getAttribute("jMessage");
	
}
else if(jEvent != null && jEvent.equalsIgnoreCase("S_Delete")){
		jMessage = (String)request.getAttribute("jMessage");
	
}
else if(jEvent != null && jEvent.equalsIgnoreCase("Student_Email")){
		jMessage = (String)request.getAttribute("jMessage");
	
}
else if(jEvent != null && jEvent.equalsIgnoreCase("Generate_Certificate")){
	jMessage = (String)request.getAttribute("jMessage");
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Student
							</div>
							<div class="actions">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								...
								<div class="row">
									<div class="col-md-12">
										...
										<form action="LoginServlet" method="post" id="contact" name="contact" class="form-horizontal form-bordered">
										<div class="col-md-3">
										&nbsp;
										</div>
										<div class="col-md-3">
							...
							<tr>
								...
								<th scope="col">Allot Other Batch</th>
								<th scope="col">View Details</th>
							   
							</tr>
							</thead>
							<tbody id="studentprofile">
...
$('#subject_id').on('change',function(){
	...
	$.get("StudentAction",
   	    ...
   	    function(data,status){
    	    ...
    	    {
		 			  subject_id: $('#subject_id').val(),
         	      jEventName: "View_StudentBySubject"
    	    },
    	    function(data,status){
    	      //alert("Data: " + data + "\nStatus: " + status);
    	    	//alert(data);
	 ...
	 $.get("StudentAction",
    	    {
		 			subject_id: $('#subject_id').val(),
		 			batch: $('#batch').val(),
         	      jEventName: "View_StudentBySubjectAndBatch"
    	    },
    	    function(data,status){
    	      //alert("Data: " + data + "\nStatus: " + status);
    	    	//alert(data);
