		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="Downloads.jsp">View Downloads</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Syllabus And Video Downloads
							</div>
							<div class="actions">
						...
						<div class="portlet-body">
								...
								<div class="row">
									<div class="col-md-12">
										...
										<div class="col-md-3">
														<select class="form-control select2_category" name="type" id="type">
							...
							<tr>
								...
								<th scope="col">Downloads Type</th>
								<th scope="col">Time Stamp</th>
								<th scope="col">Add To Campaign</th>
	...
	var d='',d2='';
	   var handleDateRangePickers = function () {
		   $('#reportrange').daterangepicker({
		     ...
		     var getAllDownloads=function ()
		     {
		    	 $('#profile_loading').show();
		    	 $.get("ServletAction",
		        	    {
		             	        jEventName: "ViewDownloads"
		        	    },
		        	    function(data,status){
		        	      //alert("Data: " + data + "\nStatus: " + status);
		        	    	//alert(data);
...
var setCampaign=function(name,email,course,n)
{
	 $('#loading'+n).show();
	 $.get("ServletAction",
   	    {
		 			...
		 			email: email,
		 			course: course,
        	        jEventName: "Update_CampaignDownload"
   	    },
   	    function(data,status){
   	    	 ...
   	    	 $('#b'+n).hide();
             $('#campaign'+n).show();
   	    	 $('#campaign'+n).html("Added Successfully");
   	    });
};
</script>
<!-- END JAVASCRIPTS -->
