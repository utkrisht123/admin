...
if(jEvent != null && jEvent.equalsIgnoreCase("U_W_Account")){
	jMessage = (String)request.getAttribute("jMessage");
	al = (ArrayList<String>)request.getAttribute("data");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("D_W_Account")){
	al = (ArrayList<String>)request.getAttribute("data");
	jMessage = (String)request.getAttribute("jMessage");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("G_W_Account")){
	al = (ArrayList<String>)request.getAttribute("data");	
}
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="SC_Batch.jsp">Schedule Batch</a>
					</li>
				</ul>
			...
			<div class="row">
						...
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>Schedule Batch
							</div>
						...
						<% 
									...
									if(jEvent != null && jEvent.equalsIgnoreCase("C_Session")){
										al=(ArrayList<String>)request.getAttribute("data");
						...
						<div class="table-scrollable">
							...
							<tr class="odd gradeX">
								<td><select class="form-control input-big input-inline" id="subject_id" name="subject_id" >
							...
							<td><select class="form-control input-small select2_category" name="batch" id="batch" >
															</select></td>
							<td  ><input class="form-control form-control-inline input-small"  type="text" name="module" id="module" /></td>
							<td><input class="form-control form-control-inline input-small date-picker" type="text" name="date" id="date" value="" /></td>
							<td>
							<select class="form-control input-small input-inline" id="email" name="email" >
													...
													<%
														...
														%>
														<option value="<%=emAl.get(i) %>"><%=emAl.get(i) %></option>
															<%} %>
											</select>
							
							</td>
							<td><input class="form-control form-control-inline input-small" type="text" name="meeting_id" id="meeting_id" /></td>
							<td><input class="form-control form-control-inline input-big"  type="text" name="url" id="url" /></td>
							<td  ><button type="submit" class="btn green">Add Session</button>
							<input type="hidden" name="jEventName" value="C_Session" />
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Schedule Batch
							</div>
						...
						<% 
									...
									if(jEvent != null && jEvent.equalsIgnoreCase("Delete_ScheduleBatch")){
									...
									%>
						<div id="detail_loading" style="display: none;">
							...
							<tr>
								...
								<th scope="col">Created By</th><th scope="col">Batch</th><th scope="col">Module</th><th scope="col">Date</th><th scope="col">Webinar Email</th><th scope="col">Meeting Id</th><th scope="col">URL</th><th scope="col">Edit</th><th scope="col">Delete</th>
							...
							<td><%=s2[7] %></td>
							<td><%=s2[8] %></td>
							<td><a class="fancybox fancybox.iframe" href="LoginServlet?jEventName=Edit_ScheduleBatch&id=<%=s2[0] %>&subject_id=<%=s2[9] %>&batch=<%=s2[3] %>&module=<%=s2[4] %>&email=<%=s2[6] %>&date=<%=s2[5] %>&meeting_id=<%=s2[7] %>&url=<%=s2[8] %>">Edit</a></td>
							<td><a  href="LoginServlet?jEventName=Delete_ScheduleBatch&id=<%=s2[0] %>&subject_id=<%=s2[9] %>&batch=<%=s2[3] %>" onclick="return check();">Delete</a></td>
	 ...
	 $.get("LoginServlet",
     	    {
		 			subject_id: $('#subject_id').val(),
		 			batch: $('#batch').val(),
          	      jEventName: "G_WebinarScheduleBatch"
     	    },
     	    function(data,status){
     	      //alert("Data: " + data + "\nStatus: " + status);
     	    	//alert(data);
