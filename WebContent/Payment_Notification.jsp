...
if(jEvent != null && jEvent.equalsIgnoreCase("CCA_Read")){
	jMessage=(String)request.getAttribute("jMessage");
	al=(ArrayList<String>)request.getAttribute("data");
	al2=(ArrayList<String>)request.getAttribute("data2");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("Paypal_Read")){
	jMessage=(String)request.getAttribute("jMessage");
	al=(ArrayList<String>)request.getAttribute("data");
	al2=(ArrayList<String>)request.getAttribute("data2");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("Payment_Notification")){
...
<div class="page-sidebar-wrapper">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Payment <small> Notification</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="PaymentServlet?jEventName=Payment_Notification">Payment Notification</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>CCAvenue Payment Notification
							</div>
						...
						<div class="portlet-body">
							...
							<thead>
							<tr>
								<th scope="col" class="table-checkbox" width="7%">
									<input type="checkbox" class="group-checkable" data-set="#sample_2 .checkboxes"/>
									<input type="submit" value="Read" class="btn green" />
								</th>
							...
							<tr class="odd gradeX">
								<td >
									<input type="checkbox" class="checkboxes" name="c" value="<%=s2[5] %>"/>
								</td>
						...
						<input type="hidden" name="jEventName" value="CCA_Read" />
							</form>
			...
			<div class="clearfix">
				...
				<div class="col-md-12">
					...
					<div class="portlet box yellow">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>PayPal Payment Notification
							</div>
						...
						<div class="portlet-body">
							...
							<% 
									if(jEvent != null && jEvent.equalsIgnoreCase("PayPal_Read")){
    					...
    					<div class="table-scrollable">
							...
							<tr class="odd gradeX">
								<td >
									<input type="checkbox" class="checkboxes" name="c2" value="<%=s2[16] %>"/>
								</td>
							...
							<input type="hidden" name="jEventName" value="PayPal_Read" />
							</form>
