...
<% 
	// jEventName is used for check book is created or not
	String jEvent = (String)request.getAttribute("jEventName");
	// jMessage is used for get success or error message	
	String jMessage ="";
	
	if(!(jEvent != null))	
		jEvent = "Intial";
	if(jEvent != null && jEvent.equalsIgnoreCase("NewBook")){
		jMessage = (String)request.getAttribute("jMessage");
		request.setAttribute("jMessage","");
	}
%>
<!DOCTYPE html>
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu " data-auto-scroll="true" data-slide-speed="200">
				...
				<li>
					...
					<span class="title">Register/Book Management System</span>
					<span class="arrow "></span>
					</a>
					<ul class="sub-menu">
						<li>
						...
						<li class="active">
							...
							Add Book</a>
                                                ...
                                                <li>
							<a href="info_book.jsp">
							<i class="fa fa-plus"></i>
							Book Information</a>
						</li>
                                                <li>
							<a href="info_register.jsp">
							<i class="fa fa-plus"></i>
				...
				<div class="col-md-12">
					<div class="portlet box blue" id="form_wizard_1">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i> Create Book Information
							</div>
						...
						<div class="portlet-body form">
								<%if(jMessage.equalsIgnoreCase("error")){%>
								<div class="alert alert-danger alert-dismissible" role="alert">
								  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
								  <strong>Error!</strong> Book will not be added
								</div>
								<%}else if(jMessage.equalsIgnoreCase("success")){%>
								<div class="alert alert-success alert-dismissible" role="alert">
								  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
								  <strong>Success!</strong> Book successfully added
								</div>
								<%}else if(jMessage.equalsIgnoreCase("exist")){%>
								<div class="alert alert-danger alert-dismissible" role="alert">
								  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
								  <strong>Error!</strong> Book Id already Exist
								</div>
								<%} %>
								<!-- BEGIN FORM-->
								<form action="LoginServlet" method="post" class="form-horizontal">
									<div class="form-body">
										<div class="form-group">
											<label class="col-md-3 control-label">Book Id <span class="required">* </span></label>
											<div class="col-md-4">
												<input type="text" name="book_id" class="form-control" placeholder="Enter Book Id *" maxlength="40" required>
												<span class="help-block">
												Please enter book id </span>
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">Book Name <span class="required">* </span></label>
											<div class="col-md-4">
												<input type="text" class="form-control" name="book_name" placeholder="Enter Book Name *" maxlength="190" required>
													<span class="help-block">
									...
									<div class="form-actions">
										<div class="row">
											<div class="col-md-offset-3 col-md-9">
												<input type="hidden" name="jEventName" value="NewBook">
