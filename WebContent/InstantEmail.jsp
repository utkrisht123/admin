...
<div class="page-sidebar-wrapper">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Instant Email <small>View</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="InstantEmail.jsp">Instant Email</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Live Demo Email
							</div>
							<div class="actions">
		   ...
		   $('#reportrange').daterangepicker({
		     ...
		     var getCSV=function ()
		     {
		         	var course= $('#course').val();
		           	var url="EmailCSV?d="+d+"&d2="+d2+"&course="+course;
