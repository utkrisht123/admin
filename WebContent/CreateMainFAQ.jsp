...
String jMessage="";
String name="",designation="",id="",course="",review="",star="",image="";
String jEventName="C_MainFAQ";
String url="CreateMainFAQ.jsp",mg="Create MainFAQ";
if(!(jEvent != null))	
	jEvent = "Intial";

if(jEvent != null && jEvent.equalsIgnoreCase("C_MainFAQ")){
	...
	review=(String)request.getAttribute("review");
	star=(String)request.getAttribute("star");
	image=(String)request.getAttribute("image");
	jEventName="C_MainFAQ";
	mg="Create Main FAQ";
	url="CreateMainFAQ.jsp";
}
else if(jEvent != null && jEvent.equalsIgnoreCase("E_MainFAQ")){
	...
	star=(String)request.getAttribute("star");
	image=(String)request.getAttribute("image");
	jEventName="U_MainFAQ";
	mg="Edit Main FAQ";
	url="LoginServlet?jEventName=E_MainFAQ&id="+id;
}
else if(jEvent != null && jEvent.equalsIgnoreCase("U_MainFAQ")){
	id=(String)request.getAttribute("id");
	name=(String)request.getAttribute("name");
	designation=(String)request.getAttribute("designation");
	course=(String)request.getAttribute("course");
...
String str[]={"5","4.5","4","3.5","3","2.5","2","1.5","1","0.5"};
							...
							<form action="LoginServlet" method="post" id="form_sample_3" class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-6">
											<textarea class="wysihtml5 form-control" rows="6" name="review" data-error-container="#editor2_error" required="required"><%=review%></textarea>
											<div id="editor2_error">
											</div>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Star<span class="required">
										* </span>
										</label>
										<div class="col-md-6">
											<select class="form-control input-big input-inline" id="star" name="star" required="required">
												<%
												for(int i=0;i<str.length;i++)
												{
													String msg="";
													if(star.equalsIgnoreCase(str[i]))
														msg="selected";
												%>
														<option value="<%=str[i] %>" <%=msg%>><%=str[i] %></option>
												<%
												}
												%>
								...
								<div class="form-actions">
									<div class="row">
										...
										<%
										if(jEvent!=null && (jEvent.equalsIgnoreCase("E_MainFAQ") || jEvent.equalsIgnoreCase("U_MainFAQ")))
										{
										%>
