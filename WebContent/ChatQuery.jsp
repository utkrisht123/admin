...
String jMessage="";
String name="",datetime="",email="",phone="",course="",country="",type="",id="",source="",url="";
String jEventName="C_ChatQuery";
if(!(jEvent != null))	
	jEvent = "Intial";

if(jEvent != null && jEvent.equalsIgnoreCase("C_ChatQuery")){
	jMessage=(String)request.getAttribute("jMessage");
	datetime=(String)request.getAttribute("datetime");
	...
	jEventName="C_ChatQuery";
}
else if(jEvent != null && jEvent.equalsIgnoreCase("E_ChatQuery")){
	datetime=(String)request.getAttribute("datetime");
	name=(String)request.getAttribute("name");
	course=(String)request.getAttribute("course");
	email=(String)request.getAttribute("email");
	...
	source=(String)request.getAttribute("source");
	url=(String)request.getAttribute("url");
	jEventName="U_ChatQuery";
}
else if(jEvent != null && jEvent.equalsIgnoreCase("U_ChatQuery")){
	datetime=(String)request.getAttribute("datetime");
	name=(String)request.getAttribute("name");
	course=(String)request.getAttribute("course");
	email=(String)request.getAttribute("email");
...
if(type.equalsIgnoreCase("Chat"))
	...
	m3="selected";
if(url.equalsIgnoreCase("Main Website"))
	t1="checked";
else if(url.equalsIgnoreCase("Landing Page"))
	t2="checked";
else
	t3="checked";
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="ChatQuery.jsp">Chat Query</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Chat Query
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="livedemo.do" method="post" id="form_sample_3" class="form-horizontal">
								<div class="form-body">
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="name" data-required="1" class="form-control" required="required" value="<%=name%>"/>
										</div>
									</div>
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="email" name="email" data-required="1" class="form-control" required="required" value="<%=email %>"/>
										</div>
									</div>
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="phone" data-required="1" class="form-control" required="required" value="<%=phone%>"/>
										</div>
									</div>
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<select class="form-control select2me" id="course" name="course" required="required">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Query Type<span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<select class="form-control select2me" id="type" name="type" required="required">
													<option value="" >Select Type</option>
													<option value="Chat" <%=m1 %>>Chat</option>
													<option value="Phone" <%=m2 %>>Phone</option>
													<option value="Email" <%=m3 %>>Email</option>
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="country" data-required="1" class="form-control" required="required" value="<%=country%>"/>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Source<span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<input type="text" name="source" data-required="1" class="form-control" required="required" value="<%=source%>"/>
										</div>
									</div>
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<label>
											<input type="radio" name="url" id="optionsRadios1" value="Main Website" <%=t1 %>> Main Website</label>
											<label>
											<input type="radio" name="url" id="optionsRadios2" value="Landing Page" <%=t2 %>> Landing Page </label>
											<label>
											<input type="radio" name="url" id="optionsRadios3" value="Other" <%=t3 %>> Other </label>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Date Time<span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<div class="input-group date form_datetime" >
																	<input type="text" size="16" name="datetime" value="<%=datetime %>" required="required" readonly class="form-control">
								...
								<div class="form-actions">
									<div class="row">
										...
										<%
										if(jEvent!=null && (jEvent.equalsIgnoreCase("E_ChatQuery") || jEvent.equalsIgnoreCase("U_ChatQuery")))
										{
										%>
