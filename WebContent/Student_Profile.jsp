		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="Student_Profile.jsp">Student Profile</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>Student Profile
							</div>
							<div class="actions">
							...
							<div class="table-toolbar">
								...
								<div class="row">
									<div class="col-md-12">
										...
										<form action="StudentAction" method="post" id="contact" name="contact" class="form-horizontal form-bordered">
										<div class="col-md-3">
										&nbsp;
										</div>
										<div class="col-md-3">
...
$('#subject_id').on('change',function(){
	...
	$.get("StudentAction",
			...
			$.get("StudentAction",
     	    {
		 			  subject_id: $('#subject_id').val(),
          	      jEventName: "StudentProfileBySubject"
     	    },
     	    function(data,status){
     	      //alert("Data: " + data + "\nStatus: " + status);
     	    	//alert(data);
	 ...
	 $.get("StudentAction",
     	    {
		 			subject_id: $('#subject_id').val(),
		 			batch: $('#batch').val(),
          	      jEventName: "StudentProfileBySubjectAndBatch"
     	    },
     	    function(data,status){
     	      //alert("Data: " + data + "\nStatus: " + status);
     	    	//alert(data);
