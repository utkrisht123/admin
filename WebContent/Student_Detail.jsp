...
String jMessage =  null;
	...
	List<com.Student> list3 = new ArrayList<com.Student>();
	list3=(List<com.Student>)request.getAttribute("data");
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="StudentAction?jEventName=Student_Detail&student_id=<%=studentId%>">Student Detail</a>
					</li>
				</ul>
						...
						<div class="portlet light bordered">
									...
									<div class="portlet-title">
										<div class="caption">
											...
											<span class="caption-subject font-blue-hoki bold uppercase">Student Info</span>
									...
									<div class="portlet-body form">
										...
										<form action="#" class="horizontal-form">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" id="s_id" name="s_id" class="form-control" value="<%=studentId%>" readonly="readonly">
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" id="s_name" name="s_name" class="form-control" value="<%=studentName%>">
											...
											<div class="form-actions right">
												...
												<a  href="StudentAction?jEventName=LMS_Link&email=<%=email %>&name=<%=studentName %>&phone=<%=mobile %>&s_id=<%=studentId %>" ><button type="button" class="btn purple" id="allotbatch">Send LMS Link</button></a>
												<a class='fancybox fancybox.iframe' href="ChangePassword.jsp" ><button type="button" class="btn red" id="allotbatch">Change Password</button></a>
											</div>
					
											<input type="hidden" name="jEventName" value="U_S_Profile" />
										</form>
										<!-- END FORM-->
									</div>
								</div>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>Alloted Student Batch
							</div>
							<div class="actions">
						...
						<div class="portlet-body">
							...
							<td><a href="StudentAction?jEventName=D_S_Batch&s_id=<%=studentId %>&batch=<%=list3.get(i).getBatch() %>" onclick="return check();">Delete</a></td>
						</tr>
							<%
							}
								%>
...
$("#allotbatch").click(function(){
	var id='<%=studentId%>';
    location.replace("S_Allot.jsp?s_id="+id);
});
function check()
{
