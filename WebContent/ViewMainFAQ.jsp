...
if(jEvent != null && jEvent.equalsIgnoreCase("U_MainFAQ")){
	jMessage=(String)request.getAttribute("jMessage");
	al=(List<Faq>)request.getAttribute("data");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("Delete_MainFAQ")){
	jMessage=(String)request.getAttribute("jMessage");
	al=(List<Faq>)request.getAttribute("data");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("V_MainFAQ")){
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="LoginServlet?jEventName=V_MainFAQ">View Main FAQ</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Main FAQ
							</div>
						...
						<% 
							...
							<tr>
								...
								<th scope="col">Name</th><th scope="col">Designation</th><th scope="col">Course</th><th scope="col">Review</th>
								<th scope="col">Star</th><th scope="col">Image</th>
							...
							<td><%=al.get(i).getDesignation() %></td>
							<td><%=al.get(i).getCourse() %></td>
							<td><%=al.get(i).getReview() %></td>
							<td><%=al.get(i).getStar() %></td>
							<td><%=al.get(i).getImage() %></td>
							<td><a  href="LoginServlet?jEventName=E_MainFAQ&id=<%=al.get(i).getFaqId() %>">Edit</a></td>
							<td><a  href="LoginServlet?jEventName=Delete_MainFAQ&id=<%=al.get(i).getFaqId() %>" onclick="return check();">Delete</a></td>
