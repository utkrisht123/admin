...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Webinar Account <small>create</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="W_Acount.jsp">Webinar Account</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Webinar Account
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							...
							<form action="LoginServlet" method="post" id="form_sample_3" class="form-horizontal">
								<div class="form-body">
									...
									<% 
									if(jEvent != null && jEvent.equalsIgnoreCase("C_W_Account")){
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="created_date" data-required="1" class="form-control form-control-inline input-medium date-picker"/>
										</div>
									</div>
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="expiry_date" data-required="1" class="form-control form-control-inline input-medium date-picker"/>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-4">
											...
											<input type="radio" name="status" class="emailaction" id="optionsRadios4" value="True" checked> True </label>
											<label class="radio-inline">
											<input type="radio" name="status" class="emailaction" id="optionsRadios5" value="False"> False </label>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											...
											<input type="hidden" name="jEventName" value="C_W_Account"/>
										</div>
									</div>
								</div>
