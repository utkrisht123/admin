		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="Teacher_Profile.jsp">Teacher Profile</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>Teacher Profile
							</div>
							<div class="actions">
						...
						<div class="portlet-body">
							...
							<td><a href="LoginServlet?teacher_id=<%=list.get(i).getTeacherId() %>&teacher_name=<%=list.get(i).getTeacherName() %>&jEventName=T_Profile" target="_blank">View Profile</a></td>
