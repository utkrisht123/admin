...
if(jNotification==null)
	jNotification="";
String jMessage="";
String jEventName = (String)request.getAttribute("jEventName");
List<com.LiveDemo> list=(List<com.LiveDemo>)request.getAttribute("livedemo");
String course=(String)request.getAttribute("course");
if(jEventName!=null && jEventName.equalsIgnoreCase("R_LiveDemo"))
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Live Demo Notification <small>Read</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="livedemo.do?jEventName=N_L_DEMO&course=<%=course %>">Live Demo Notification</a>
				...
				<div class="col-md-12">
					...
					<div class="portlet box yellow">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-user"></i><%=course %> Live Demo Notification
							</div>
							<div class="actions">
						...
						<div class="table-scrollable">
							...
							<thead>
							<tr>
								<th scope="col" class="table-checkbox" width="10%">
...
<tr class="odd gradeX">
<td >
<input type="checkbox" class="checkboxes" name="c" value="<%=list.get(i).getEmail() %>"/>

</td>
<td><a class='fancybox fancybox.iframe' href="LoginServlet?jEventName=S_Info&id=<%=list.get(i).getQueryId() %>&lp_id=<%=list.get(i).getLpId() %>&cookie_id=<%=list.get(i).getCookieId() %>" ><%=list.get(i).getStudentName() %></a></td>
<%
...
<%
							...
							<input type="hidden" name="jEventName" value="R_LiveDemo" />
