<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
       <jsp:useBean id="c2" class="com.LiveDemoDAO"></jsp:useBean>
        <jsp:useBean id="c" class="com.StudentDAO"></jsp:useBean>
...
<div class="page-sidebar-wrapper">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Allot Student <small> Batch</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="S_Allot.jsp">Allot Student</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Allot Student Batch
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							...
							<form action="LoginServlet" method="post" id="form_sample_3" class="form-horizontal">
								<div class="form-body">
									...
									if(studentId==null)
										studentId="";
									if(jEvent != null && jEvent.equalsIgnoreCase("S_Allot")){
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<select class="form-control select2me" name="student_id" id="student_id">
											<option value="">Select Student</option>
												<%
												ArrayList<String> al=new ArrayList<String>();
												al=c2.getCourse();
												List<com.Student> al2=new ArrayList<com.Student>();
												al2=c.getStudent();
												for(int i=0;i<al2.size();i++)
												{
													String msg="";
													if(studentId.equals(al2.get(i).getStudentId()) || email.equalsIgnoreCase(al2.get(i).getEmail()))
														msg="selected";
												%>
												<option value="<%=al2.get(i).getStudentId() %>" <%=msg %>><%=al2.get(i).getStudentId()+"-"+al2.get(i).getStudentName()+"-"+al2.get(i).getEmail() %></option>
												<%} %>
											</select>
										</div>
									</div>
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<select class="form-control select2_category" name="subject_id" id="subject_id">
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="date" id="date" data-required="1" class="form-control" readonly="readonly"/>
										</div>
									</div>
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="time" id="time" data-required="1" class="form-control" readonly="readonly"/>
										</div>
									</div>
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="batch_type" id="batch_type" data-required="1" class="form-control" readonly="readonly"/>
										</div>
									</div>
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="bprice" id="bprice" data-required="1" class="form-control" readonly="readonly"/>
										</div>
									</div>
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="discount" id="discount" data-required="1" class="form-control" readonly="readonly"/>
										</div>
									</div>
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="fprice" id="fprice" data-required="1" class="form-control" readonly="readonly"/>
										</div>
									</div>
								</div>
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											<button type="submit" class="btn green">Allot</button>
											<button type="button" class="btn default">Cancel</button>
											<input type="hidden" name="jEventName" value="S_Allot"/>
										</div>
									</div>
								</div>
