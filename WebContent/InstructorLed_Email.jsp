		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="Send_Custom_Email.jsp"> Instructor Led Email</a>
...
if(phone==null )
	phone="";
if((country==null)||(country.equalsIgnoreCase("null"))||(country.equalsIgnoreCase("HO"))||(country.equalsIgnoreCase("undefined")))
	country="IN";
...
con=countries.get(country);
%>
			<h3 class="page-title">
			Instructor Led Email <small> send request</small>
			</h3>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Send Instructor Led Email
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							...
							<form action="EmailServlet" method="Post" id="form_sample_3" class="form-horizontal">
								<div class="form-body">
									...
									if(jEvent != null && jEvent.equalsIgnoreCase("InstructorEmail")){
										...
										<%
										}else if(jEvent != null && jEvent.equalsIgnoreCase("Error")){
									%>
										...
										* </span>
										...
										<div class="col-md-4">
											<div class="input-group">
												...
												<input type="country" name="country" class="form-control" placeholder="country" value="<%=con %>" required="required">
											</div>
										</div>
									</div>
								</div>
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											...
											<input type="hidden" name="jEventName" value="Send_BatchDetail"/>
