...
if(jEvent != null && jEvent.equalsIgnoreCase("C_Category")){
	jMessage = (String)request.getAttribute("jMessage");
	
}
else if(jEvent != null && jEvent.equalsIgnoreCase("E_Category")){
	categoryId = (String)request.getAttribute("categoryId");
	categoryName = (String)request.getAttribute("categoryName");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("U_Category")){
	jMessage = (String)request.getAttribute("jMessage");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("D_Category")){
	jMessage = (String)request.getAttribute("jMessage");	
}
							...
							<div class="form-body">
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="name" id="name" data-required="1" class="form-control" required="required" value="<%=categoryName %>"  />
										</div>
									</div>
								...
								<div class="form-actions">
									...
									if(jEvent != null && jEvent.equalsIgnoreCase("E_Category") ){
	
										%>
										<button type="submit" class="btn green">Update</button>
										<input type="hidden" name="jEventName" value="U_Category" />
											<input type="hidden" name="id" value="<%=categoryId%>" />
											<input type="hidden" name="old_name" value="<%=categoryName%>" />
										<%
											}
									else
									{
										...
										<input type="hidden" name="jEventName" value="C_Category" />
										<%
									}
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Category
							</div>
						...
						<% 
									...
									if(jEvent != null && jEvent.equalsIgnoreCase("Update_Categry")){
						...
						<div id="detail_loading" style="display: none;">
							...
							<tr>
								...
								<th scope="col">Category Name</th><th scope="col">Edit</th><th scope="col">Delete</th>
							...
							<tr class="odd gradeX">
								...
								<td><%=i+1 %></td>
								<td><%=s2[1] %></td>
								<td><a  href="LoginServlet?jEventName=E_Category&id=<%=s2[0] %>&name=<%=s2[1] %>">Edit</a></td>
								<td><a  href="LoginServlet?jEventName=D_Category&id=<%=s2[0] %>" onclick="return check();">Delete</a></td>
