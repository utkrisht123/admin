...
if(jEvent != null && jEvent.equalsIgnoreCase("A_Payment")){
...
<div class="page-sidebar-wrapper">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Automatic Payment Link <small> Send</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="Automatic_Payment.jsp">Automatic Payment Link</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Automatic Payment Link
							</div>
							<div class="tools">
								...
								<div class="form-body">
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="final_price" id="final_price"  data-required="1" class="form-control" required="required" />
										</div>
									</div>
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<select class="form-control input-big input-inline" id="payment_in" name="payment_in" required="required">
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											...
											<input type="hidden" name="jEventName" value="A_Payment"/>
