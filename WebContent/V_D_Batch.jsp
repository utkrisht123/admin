...
if(jEvent != null && jEvent.equalsIgnoreCase("U_D_Batch")){
	jMessage=(String)request.getAttribute("jMessage");
	al=(ArrayList<String>)request.getAttribute("data");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("D_D_Batch")){
	jMessage=(String)request.getAttribute("jMessage");
	al=(ArrayList<String>)request.getAttribute("data");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("G_D_Batch")){
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Demo Batch <small> updation</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="LoginServlet?jEventName=G_D_Batch">View Demo Batch</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Demo Batch
							</div>
    					...
    					<div class="table-scrollable">
							...
							<tr>
								...
								<th  scope="col">Subject</th><th  scope="col">Demo Batch Id</th><th  scope="col">Start Date</th><th  scope="col">Start Time</th><th  scope="col">Meeting Id</th><th  scope="col">URL</th><th  scope="col">Edit</th><th  scope="col">Delete</th>
							...
							<td><%=s2[5] %></td>
							<td><%=s2[6] %></td>
							<td><a  href="LoginServlet?jEventName=E_D_Batch&subject_id=<%=s2[0] %>&d_batch_id=<%=s2[2] %>&s_date=<%=s2[3] %>&s_time=<%=s2[4] %>&meeting_id=<%=s2[5]%>&url=<%=s2[6]%>">Edit</a></td>
							<td><a  href="LoginServlet?jEventName=D_D_Batch&d_batch_id=<%=s2[2] %>" onclick="return check();">Delete</a></td>
