...
String jMessage="";
String question="",answer="",id="",course="",faq_type="",title="",keyword="",description="";
String jEventName="C_FAQ";
String url="CreateFAQ.jsp",mg="Create FAQ";
if(!(jEvent != null))	
	jEvent = "Intial";

if(jEvent != null && jEvent.equalsIgnoreCase("C_FAQ")){
	...
	faq_type=(String)request.getAttribute("faq_type");
...
else if(jEvent != null && jEvent.equalsIgnoreCase("E_FAQ")){
	...
	jEventName="U_FAQ";
	mg="Edit FAQ";
	url="LoginServlet?jEventName=E_FAQ&id="+id;
}
else if(jEvent != null && jEvent.equalsIgnoreCase("U_FAQ")){
	id=(String)request.getAttribute("id");
	question=(String)request.getAttribute("question");
	answer=(String)request.getAttribute("answer");
	course=(String)request.getAttribute("course");
...
if(faq_type!=null && faq_type.equalsIgnoreCase("Class"))
	m1="selected";
else if(faq_type!=null && faq_type.equalsIgnoreCase("Support"))
	m2="selected";
else if(faq_type!=null && faq_type.equalsIgnoreCase("Payment"))
	m3="selected";
else if(faq_type!=null && faq_type.equalsIgnoreCase("Certification"))
	m4="selected";
else if(faq_type!=null && faq_type.equalsIgnoreCase("Pre-requisite"))
	m5="selected";
							...
							<form action="LoginServlet" method="post" id="form_sample_3" class="form-horizontal">
								...
								<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-6">
											<%--- <textarea  class="form-control" rows="3" name="question"  required="required" ><%=question%></textarea>--%>
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-6">
											<textarea class="wysihtml5 form-control" rows="6" name="answer" data-error-container="#editor2_error" required="required"><%=answer%></textarea>
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-6">
											<textarea class="form-control" rows="3" name="title" required="required"><%=title%></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Keyword<span class="required">
										* </span>
										</label>
										<div class="col-md-6">
											<textarea class="form-control" rows="3" name="keyword" required="required"><%=keyword%></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Keyword Description<span class="required">
										* </span>
										</label>
										<div class="col-md-6">
											<textarea class="form-control" rows="3" name="description" required="required"><%=description%></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">FAQ Type<span class="required">
										* </span>
										</label>
										<div class="col-md-6">
											<select class="form-control input-big input-inline" id="faq_type" name="faq_type" required="required">
													<option value="" >Select </option>
														<option value="Class" <%=m1%>>Class</option>
														<option value="Support" <%=m2%>>Support</option>
														<option value="Payment" <%=m3%>>Payment</option>
														<option value="Certification" <%=m4%>>Certification</option>
														<option value="Pre-requisite" <%=m5%>>Pre-requisite</option>
								...
								<div class="form-actions">
									<div class="row">
										...
										<%
										if(jEvent!=null && (jEvent.equalsIgnoreCase("E_FAQ") || jEvent.equalsIgnoreCase("U_FAQ")))
										{
										%>
											<button type="submit" class="btn green">Update FAQ</button>
											<input type="hidden" name="id" value="<%=id %>"/>
											<input type="hidden" name="oldQuestion" value="<%=question %>"/>
											<%
										}
										else
										{
