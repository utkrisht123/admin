...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			View <small> Press Release</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="view_press.jsp">View Press Release</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Press Release
							</div>
    					...
    					<div class="table-scrollable">
							...
							<tr class="odd gradeX" data-ng-repeat="x in press">
								
							<td>{{$index+1}}</td>
							<td>{{x.Date}}</td>
							<td>{{x.heading}}</td>
							<td data-ng-bind-html="x.description|unsafe"></td>
							<td>
							<span  data-ng-if="x.display=='y'">Display</span>
							<span  data-ng-if="x.display=='n'"> Not Display</span>
							</td>
							<td>{{x.user}}</td>
							<td><a  href="edit-press.jsp?id={{x.ID}}">Edit</a></td>
							<td><a  href="" data-ng-click="deleteItem($index,x.ID)">Delete</a></td>
...
app.controller('myCtrl', function($scope,$http,$q) {
	...
	var url1="press?jEventName=view";
	
	 $http.get(url1).success(function(response){
	   $scope.press = response.records;
	   $("#loading").hide();
	   $("#records_table").removeClass("ihh");
	  // console.log(response);
	 });
	   $scope.deleteItem = function (index,id) {
		   $http.get("press?jEventName=delete&id="+id).success(function(){
		   $scope.press.splice(index, 1);
		   });
		}
});
</script>
