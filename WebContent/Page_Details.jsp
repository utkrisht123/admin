		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="Page_Details.jsp">View Page Details</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Page Details
							</div>
	    					...
	    					<div class="table-scrollable">
								<table class="table table-striped table-bordered table-hover" id="sample_3">
									...
									<tbody  id=records_table>                       
										<tr class="odd gradeX" id=records_table data-ng-repeat="x in page|filter:searchText">								
										<td>{{ x.PAGE_ID }}</td>
...
app.controller('myCtrl', function($scope,$http,$q) {
	...
	var url1="Page_Details?jEventName=page";
	
	 $http.get(url1).success(function(response){
	   $scope.page = response.records;
