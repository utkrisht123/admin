...
df.setTimeZone(TimeZone.getTimeZone("Canada/Eastern"));
 ...
 String dd2=ld_date;
String ss="View All Live Demo Request";
String jEventName="Admin_LiveDemo";
String jNotification = (String)session.getAttribute("jNotification");
if(jNotification==null)
	jNotification="";

List<com.LiveDemo> list=(List<com.LiveDemo>)request.getAttribute("livedemo");
%>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			All Live Demo <small>View</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="livedemo.do?jEventName=All_LiveDemo">All Live Demo Request</a>
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-white-sharp bold uppercase">All Live Demo Request</span>
							</div>
							<div class="actions btn-set">
								<button class="btn green-haze btn-circle"><i class="fa fa-check"></i> Add</button>
								<div class="btn-group">
								...
								<div class="row">
									<div class="col-md-12">
										...
										&nbsp;&nbsp;&nbsp;
											...
											<label>
											<select class="form-control input-big input-inline" id="course" name="course" >
											...
											<label>
											<select class="form-control input-big input-inline" id="attend" name="attend"  >
											...
											<label>
											<select class="form-control input-big input-inline" name="pick" id="pick"  >
													<option value="" >Select</option>
											...
											<label>
												<select class="form-control input-big input-inline" name="requestLocation" id="requestLocation"  >
														<option value="">All Request</option>
														<option value="USA" style="color: green;">Request From USA</option>
												</select>
											</label>
												<label>
...
{
	String msg="",msg2="";
	String mb=list.get(i).getMCorrect();
	String em=list.get(i).getECorrect();
	if(mb.equals("n"))
	{
		
		msg="style='background-color: #F78181;color:white;'";
	}
	if(em.equals("n"))
	{
		
		msg2="style='background-color: #F78181;color:white;'";
	}
%>
<tr class="odd gradeX">
<td><%=i+1 %></td>
