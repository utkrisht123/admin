		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="Send_Custom_Email.jsp"> Self-Paced Email</a>
...
%>
			<h3 class="page-title">
			Self-Paced Email <small> send request</small>
			</h3>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Send Self-Paced Email
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							...
							<form action="EmailServlet" method="Post" id="form_sample_3" class="form-horizontal">
								<div class="form-body">
									...
									if(jEvent != null && jEvent.equalsIgnoreCase("SelfEmail")){
										...
										* </span>
										...
										<div class="col-md-4">
											...
											<select class="form-control input-big input-inline" id="course" name="course" required="required">
													...
													<%
														ArrayList<String> aCourse=c2.getSelfPacedCourse();
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											...
											<input type="hidden" name="jEventName" value="Send_SelfEmail"/>
