			...
			<div class="row">
				...
				<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>Update Media
							</div>
							<!-- <div class="tools">
							...
							<!-- BEGIN FORM-->
							<form  action="Update_Media" id="form_sample_3" class="form-horizontal" method="post"  enctype="multipart/form-data">
								<div class="form-body">
									...
									<% if(jMessage.equals("success")) {%>
									<div class="alert alert-success">
										<button class="close" data-close="alert"></button>
										Media Data Enter successful!
									</div>
									<%} %>
									...
									<div class="form-group">
									<label class="control-label col-md-3">Media Name<span class="required">
										* </span>
									</label>
									<div class="col-md-4">
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="name" data-required="1" class="form-control" id="name" value="MediaImage?ID=<%=ID%>"/>
										</div>
									</div>
									<div class="form-group">
									<label class="control-label col-md-3">Image<span class="required">
										* </span>
										...
										<div class="col-md-4">
											<input type="file" name="photo" size="50" style="padding-left:40px;" data-required="1"  value=""/>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Image Title <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Image Alt Text <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<input type="text" name="alt" class="form-control" id="alt" value=""/>
										</div>
									</div>
									<div class="form-group">
...
app.controller('myCtrl', function($scope,$http,$q) {
	var url1="Update_Media?jEventName=edit&id="+<%=ID%>;
	//$('#description').wysihtml5();
	 $http.get(url1).success(function(response){
	  ...
	  $("#name").val($scope.names[0].heading);
	   ...
	   $("#media").val($scope.names[0].media_name);
	   $("#datec").val($scope.names[0].Date);
	   $("#title").val($scope.names[0].title);
	   $("#alt").val($scope.names[0].alt);
	   $("#loading").hide();
