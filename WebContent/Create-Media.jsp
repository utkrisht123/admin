			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						...
						<a href="Create-Media.jsp">Enter Media</a>
						<i class="fa fa-angle-right"></i>
					</li>
				</ul>
			...
			<div class="row">
				...
				<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>Enter Media
							</div>
							<!-- <div class="tools">
							...
							<!-- BEGIN FORM-->
							<form  action="Media" id="form_sample_3" class="form-horizontal" method="post"  enctype="multipart/form-data">
								<div class="form-body">
									...
									<label class="control-label col-md-3">Image<span class="required">
										* </span>
										...
										<div class="col-md-4">
											<input type="file" name="photo" size="50" style="padding-left:40px;" data-required="1" />
										</div>
									</div>
									<div class="form-group">
								...
								<div class="form-actions">
									<div class="row">
										...
										<input type="hidden" value="entermedia" name="jEventName">
