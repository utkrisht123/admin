...
if(jEvent != null && jEvent.equalsIgnoreCase("CCA_Request")){
...
<div class="page-sidebar-wrapper">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			CCAvenue Request Only <small> View</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="PaymentServlet?jEventName=CCA_Request">CCAvenue Request</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>CCAvenue Payment Request Only
							</div>
