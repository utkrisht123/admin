...
boolean flag=false;
String ss="View Today Live Demo Request";
...
df.setTimeZone(TimeZone.getTimeZone("Canada/Eastern"));
 ...
 String dd2=ld_date;
String jEventName="Today_LiveDemo";
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Today Live Demo <small>View</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="livedemo.do?jEventName=Today_LiveDemo">Today Live Demo Request</a>
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Today Live Demo Request</span>
							</div>
