...
else if(jEvent != null && jEvent.equalsIgnoreCase("C_Info")){
				...
				<div class="col-md-12">
					...
					%>
						...
						<td>
							...
							<a  href="LoginServlet?jEventName=G_BatchDetail&subject=Hadoop&id=<%=id %>&lp_id=<%=lpId %>&cookie_id=<%=cookie_id %>&jevent=call" id="view_batch"><input type="button" name="b2" class="btn btn-circle blue-madison" value="View Batch Detail"  /></a>
								&nbsp;&nbsp;&nbsp;&nbsp;
...
<script src="scripts/callback_editable.js"></script>
...
$("#view").change(function(){
	...
	var link="LoginServlet?jEventName=G_BatchDetail&subject="+course+"&id=<%=id %>&lp_id=<%=lpId %>&cookie_id=<%=cookie_id %>&jevent=call";
