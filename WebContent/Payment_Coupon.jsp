...
if(jEvent != null && jEvent.equalsIgnoreCase("Payment_Coupon")){
...
<div class="page-sidebar-wrapper">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Payment Coupon <small> Send</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="Payment_Coupon.jsp">Payment Coupon</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Payment Coupon
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="PaymentMail" method="post" id="form_sample_3" class="form-horizontal">
								<div class="form-body">
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="email" name="email" data-required="1" class="form-control" required="required" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-4">
											<select class="form-control input-big input-inline" id="subject_id" name="subject_id" required="required">
													...
													<%
														...
														%>
														<option value="<%=s2[0] %>" ><%=s2[1] %></option>
															<%} %>
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">Select Batch <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											
											<select class="form-control select2_category" name="batch" id="batch">
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="s_date" id="s_date" data-required="1" class="form-control" required="required" readonly="readonly" />
										</div>
									</div>
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="s_time" id="s_time" data-required="1" class="form-control" required="required" readonly="readonly" />
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Base Price<span class="required" >
										* </span>
										</label>
										<div class="col-md-4">
											<input type="text" name="base_price" id="base_price" data-required="1" class="form-control" required="required" readonly="readonly" />
										</div>
									</div>
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											...
											<input type="radio" name="p_type" class="emailaction" id="optionsRadios4"  value="discount" checked> Discount </label>
											<label class="radio-inline">
											<input type="radio" name="p_type" class="emailaction" id="optionsRadios5"  value="discounted"> Discounted Price</label>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-4">
											...
											<input type="text" name="discount" id="discount" data-required="1" class="form-control" onkeyup="price();" placeholder="Enter discount in % (percentage)" />
							
											</div>
							
											<div id="discountedblock" style="display :none;">
													<input type="text" name="discounted_price" id="discounted_price" data-required="1" onkeyup="price2();" class="form-control" placeholder="Enter amount"  />
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="final_price" id="final_price" data-required="1" class="form-control" required="required" readonly="readonly" />
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Service Tax<span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<input type="text" name="tax" id="tax" data-required="1" class="form-control" required="required"  readonly="readonly"/>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Final Price<span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<input type="text" name="t_price" id="t_price" data-required="1" class="form-control" required="required" readonly="readonly"  />
										</div>
									</div>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											...
											<input type="hidden" name="jEventName" value="Payment_Coupon"/>
	 ...
	 $.get("PaymentMail",
    	    {
		 			subject_id: $('#subject_id').val(),
		 			batch: $('#batch').val(),
         	      jEventName: "BatchDetailBySubjectAndBatch"
    	    },
    	    function(data,status){
    	      //alert("Data: " + data + "\nStatus: " + status);
    	    	//alert(data);
...
function price()
{
	...
	var y=parseFloat(discount/100);
	var c=parseFloat(b_price)*parseFloat(y);
	var x=parseFloat(b_price)-parseFloat(c);
	if(!isNaN(x))
		{
		
		document.getElementById("final_price").value=x.toFixed(2);
		var s_tax = document.getElementById("tax").value;
		var z=1+parseFloat(s_tax/100);
		var y=x*z;
		document.getElementById("t_price").value=y.toFixed(2);	
		}	
	else
		{
...
function price2()
{
	var x = document.getElementById("discounted_price").value;
