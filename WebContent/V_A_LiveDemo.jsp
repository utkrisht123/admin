...
df.setTimeZone(TimeZone.getTimeZone("Canada/Eastern"));
 ...
 String dd2=ld_date;
String ss="View Live Demo Request Sent By Admin";
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Admin Live Demo <small>View</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="livedemo.do?jEventName=Admin_LiveDemo">Admin Live Demo Request</a>
					...
					<div class="portlet box yellow">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Admin Live Demo Request</span>
							</div>
