...
<div class="page-sidebar-wrapper">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Login Not Request <small>View</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="ViewLoginRequest.jsp">Login Not Request</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Login Data but not Request
							</div>
							<div class="actions">
...
Demo.init(); // init demo features
  ...
  $('#demobatchdate').html(today1);
	...
	setInterval(show, 50000);
		     ...
		     var getLoginRequest=function ()
		     {
		    	 $('#profile_loading').show();
		    	 $.get("ServletAction",
		        	    {
		             	        jEventName: "ViewLoginRequest"
		        	    },
		        	    function(data,status){
		        	      //alert("Data: " + data + "\nStatus: " + status);
		        	    	//alert(data);
...
var setCampaign=function(name,email,n)
{
	 $('#loading'+n).show();
	 $.get("ServletAction",
   	    {
		 			name: name,
		 			email: email,
        	        jEventName: "Update_CampaignLogin"
   	    },
   	    function(data,status){
