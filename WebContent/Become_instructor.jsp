...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			View <small> Become Instructor  </small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="Become_instructor.jsp">View Become Instructor</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Become Instructor
							</div>
								...
								<table class="table table-striped table-bordered table-hover" id="sample_3">
									<thead>
										<tr>
											...
											<th scope="col">Cookie_id</th>
											<th scope="col">Requested_date</th>								                       
										</tr>
									</thead>
									<tbody  id=records_table>                       
										<tr class="odd gradeX" id=records_table data-ng-repeat="x in become|filter:searchText">	
											<td>{{ $index + 1 }}</td>							
											<td>{{x.NAME}}</td>
											<td>{{ x.EMAIL }}</td>	
											<td>{{ x.PHONE}}</td>
...
app.controller('myCtrl', function($scope,$http,$q) {
	...
	var url1="ServletAction?jEventName=become";
	
	 $http.get(url1).success(function(response){
	   $scope.become = response.records;
