...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Webinar Account <small>View</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="LoginServlet?jEventName=G_W_Account">View Webinar Account</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>Webinar Account
							</div>
							<div class="actions">
						...
						<div class="portlet-body">
							...
							<td><%=s2[3] %></td>
							<td><%=s2[4] %></td>
							<td><b style="color:red;">Expire within <%=s2[5] %> days</b></td>
							<td><%=s2[6] %></td>
...
var check=function()
{
	var c=confirm("Are you sure to delete this acount");
	if(c)
		return true;
	else
		return false;
