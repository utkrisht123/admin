...
else if(jEvent != null && jEvent.equalsIgnoreCase("V_Info")){
			...
			<div class="row">
				<div class="col-md-12">
					...
					<tr>
						...
						<td style="width:45%">Self-Paced Video PopUp</td>
					</tr>
					<tr>
						<td>
							 Email
					...
					<td>
						...
						<div id="" style="margin-bottom:8px;">
							<select class="form-control input-small input-inline" id="custom_mail" name="custom_mail" >
								<%
					...
					<td>
						...
						<td colspan="2">
							...
							<div style="margin-left:50%;">	
								<input type="button" name="b1" class="btn btn-circle red" value="Batch Detail" onclick="sendBatchDetail();" />
							</div>
						<div id="coursedetail">
					...
					%>
						...
						<td colspan="3" style="background-color:#FFFFFF;">	
							...
							<a  href="LoginServlet?jEventName=G_BatchDetail&subject=Hadoop&id=<%=id %>&lp_id=<%=lpId %>&cookie_id=<%=cookie_id %>&jevent=video" id="view_batch"><input type="button" name="b2" class="btn btn-circle blue-madison" value="View Batch Detail"  /></a>
								&nbsp;&nbsp;&nbsp;&nbsp;
...
<script src="scripts/video_editable.js"></script>
...
var sendSelfEmail=function ()
{
	...
	var country=ccc;
	var name='<%=name %>';
	window.open("Self_Paced_Email.jsp?name="+name+"&id="+id+"&email="+email+"&country="+country+"&Query_type=Self-Paced Video PopUp","_blank");
};
var sendInstructorEmail=function ()
{
	...
	var country=ccc;
	var name='<%=name %>';
	window.open("InstructorLed_Email.jsp?name="+name+"&id="+id+"&email="+email+"&country="+country+"&Query_type=Self-Paced Video PopUp","_blank");
};
<%--
var sendBatchDetail=function ()
{
	...
	var country=ccc;
	var name='<%=name %>';
	window.open("Self_Paced_Email.jsp?name="+name+"&id="+id+"&email="+email+"&country="+country);
};--%>
...
$("#view").change(function(){
	...
	var link="LoginServlet?jEventName=G_BatchDetail&subject="+course+"&id=<%=id %>&lp_id=<%=lpId %>&cookie_id=<%=cookie_id %>&jevent=video";
