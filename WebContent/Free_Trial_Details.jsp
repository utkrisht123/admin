...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			View <small> Free Trial Enroll </small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="Free_Trial_Details.jsp">View Free Trial Enroll</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Free Trial Enroll
							</div>
	    					...
	    					<div class="table-scrollable">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_3">
									...
									<tbody  id=records_table>                       
										<tr class="odd gradeX" id=records_table data-ng-repeat="x in free|filter:searchText">	
											<td>{{ $index + 1 }}</td>							
											<td><a class='fancybox fancybox.iframe' style="color: purple;" href="LoginServlet?jEventName=F_Info&ID={{x.ID}}">{{ x.NAME }}</a></td>
											<td>{{ x.EMAIL }}</td>	
											<td>{{ x.IP_ADDRESS }}</td>
											<td>{{ x.PHONE }}</td>
...
app.controller('myCtrl', function($scope,$http,$q) {
	...
	var url1="Page_Details?jEventName=free";
	
	 $http.get(url1).success(function(response){
	   $scope.free = response.records;
	 ...
	 $scope.myVar = true;
		$scope.anyFunc = function (var1, var2) {
			...
			$scope.myVar = true;
			var url2="Page_Details?jEventName=detailByFilter&d="+var1+"&d2="+var2;
