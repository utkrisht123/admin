		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="Send_Webinar.jsp">Send Class Link</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Class Link
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							...
							<form action="LoginServlet" method="post" id="form_sample_3" class="form-horizontal">
								<div class="form-body">
									...
									<% 
									if(jEvent != null && jEvent.equalsIgnoreCase("Class_Link")){
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Course <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<select class="form-control select2_category" name="module" id="module" >
											<option value="">Select Module</option>
															</select>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Schedule Date <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<input type="text" name="session_date" id="session_date" data-required="1" class="form-control " readonly/>
										</div>
									</div>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											...
											<input type="hidden" name="jEventName" value="Class_Link"/>
	 ...
	 $.get("LoginServlet",
     	    {
		 			...
		 			batch: $('#batch').val(),
		 			module: $('#module').val(),
          	      jEventName: "G_SessionDateURL"
     	    },
     	    function(data,status){
     	      //alert("Data: " + data + "\nStatus: " + status);
     	    	//alert(data);
     	    	var s=data.split("abczxy");
     	    	
     	    	$('#session_date').val(s[0]);
     	    	$('#meeting_id').val(s[1]);
     	    	$('#url').val(s[2]);
     	    	$('#email').val(s[3]);
     	    	$('#password').val(s[4]);
