				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						...
						<% 
							...
							<td><%=s2[7] %></td>
							<td><%=s2[8] %></td>
							<td><a class="fancybox fancybox.iframe" href="UW_Acount.jsp?email=<%=s2[0] %>&password=<%=s2[1] %>&created_date=<%=s2[3] %>&expiry_date=<%=s2[4] %>">Edit</a></td>
							<td><a  href="LoginServlet?jEventName=D_W_Account&email=<%=s2[0] %>" onclick="return check();">Delete</a></td>
