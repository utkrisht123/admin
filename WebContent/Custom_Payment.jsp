...
if(jEvent != null && jEvent.equalsIgnoreCase("C_Payment")){
...
<div class="page-sidebar-wrapper">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Custom Payment <small> Send</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="Custom_Payment.jsp">Custom Payment</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Custom Payment
							</div>
							<div class="tools">
								...
								<div class="form-body">
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<!-- <select class="form-control select2me input-big input-inline" id="subject_id" name="subject_id" required="required">
									...
									<div id="livedemo_loading" style="display: none;margin-left: 280px;">
										<img src="img/loading.gif" alt="loading"/>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">Batch Date Time <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											
											<select class="form-control select2_category" name="datetime" id="datetime" required="required">
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-3">
											<input type="text" name="s_date" data-required="1" class="form-control form-control-inline input-medium date-picker" required="required" />
										...
										* </span>
										...
										<div class="col-md-3">
											<div class="input-group">
												<input type="text" class="form-control timepicker timepicker-24" name="s_time"  >
									...
									<div class="form-group">
										<label class="control-label col-md-3">Payment Type<span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<select class="form-control select2me input-medium input-inline" id="payment_in" name="payment_in" required="required">
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="final_price" data-required="1" class="form-control" required="required" placeholder="Enter price according to selecting Payment Type" />
										</div>
									</div>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											...
											<input type="hidden" name="jEventName" value="C_Payment"/>
