		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="CustomEmail.jsp">Custom Email</a>
					</li>
				</ul>
						...
						<div class="portlet-body form">
							...
							<form action="EmailServlet" method="post" id="form_sample_3" class="form-horizontal">
								<div class="form-body">
									...
									<% 
									if(jEvent != null && jEvent.equalsIgnoreCase("SingleEmail")){
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<textarea name="message" id="markdown" data-provide="markdown" rows="10" data-error-container="#editor_error"></textarea>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											...
											<input type="hidden" name="jEventName" value="SingleEmail"/>
										</div>
									</div>
								</div>
