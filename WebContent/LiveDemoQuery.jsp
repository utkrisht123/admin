...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Live Demo Query <small> send</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="LiveDemoQuery.jsp">Create LiveDemo Query</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="SendQueryEmail.jsp" method="post" id="form_sample_3" class="form-horizontal">
								<div class="form-body">
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="date" data-required="1" class="form-control form-control-inline input-small date-picker" required="required"/>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Query Source <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<select class="form-control select2me" name="type" id="type" required="required">
									...
									<div class="form-group" style="display: none;" id="other">
										...
										<div class="col-md-4">
											<input type="text" name="other" data-required="1" class="form-control" placeholder="Enter Query Source"/>
										</div>
									</div>
