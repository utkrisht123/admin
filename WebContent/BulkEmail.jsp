		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="BulkEmail.jsp">Bulk Email</a>
					</li>
				</ul>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Send Bulk Email
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="EmailServlet" method="post" id="form_sample_3" class="form-horizontal">
								<div class="form-body">
									...
									<% 
									if(jEvent != null && jEvent.equalsIgnoreCase("BulkEmail")){
									...
									<div class="form-group">
										<label class="control-label col-md-3">Select Email ID To Send Mail <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<select class="form-control select2me" name="emailuser" id="emailuser">
												<%
												...
												{
												%>
												<option value="<%=al2.get(i) %>"><%=al2.get(i) %></option>
												<%} %>
											</select>
										</div>
									</div>
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<select class="form-control select2me" name="course" id="course">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											...
											<label class="radio-inline">
											<input type="radio" name="optionsRadios" class="emailaction" id="optionsRadios6" value="inputemail"> Input Email</label>
										</div>
									</div>
									<div class="form-group" id="custom" style="display: none;">
										<label class="control-label col-md-3">Select Emails</label>
				...
				<div class="col-md-6 col-sm-12">
						...
						<div class="portlet-body">
							...
							<tr>
								<th class="table-checkbox">
									<input type="checkbox" id="group-checkable" class="group-checkable" data-set="#sample_2 .checkboxes"/>
								</th>
								<th>
									Name
									</th>
					...
					<!-- END EXAMPLE TABLE PORTLET-->
									...
									<div class="form-group" id="emailgo" style="display :none;">
									
										<label class="control-label col-md-3">Email</label>
										<div class="col-md-4">
										<textarea class="form-control" rows="3" name="email" id="email" placeholder="All Email Id are seperated by comma required"></textarea>
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="subject" data-required="1" class="form-control" required=""/>
											
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Html File
										</label>
										<div class="col-md-4">
											<input type="file" name="htmlfile" id="htmlfile" class="form-control" required=""/>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Message</label>
										<div class="col-md-9">
											<textarea name="message" id="markdown" data-provide="markdown" rows="10" data-error-container="#editor_error" required=""></textarea>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											...
											<input type="hidden" name="jEventName" id="jEventName" value="BulkEmail" />
										</div>
									</div>
								</div>
...
<script type="text/javascript">
  function readSingleFile(evt) {
    ...
    if (f) {
      ...
      r.onload = function(e) { 
        ...
        document.getElementById("markdown").value=contents;
      }
      r.readAsText(f);
  ...
  var readCSVFile=function(evt){
	  var f = evt.target.files[0]; 
	    ...
	    if (f) {
	      ...
	      r.onload = function(e) { 
		      var contents = e.target.result;
	        document.getElementById("email").value=contents;
	      }
	      r.readAsText(f);
  ...
  document.getElementById('optionsRadios5').addEventListener('click', show, false);
 ...
 /* function showPreview()
  {
  var s=document.getElementById('markdown').value;
