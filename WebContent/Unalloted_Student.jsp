...
if(jEvent != null && jEvent.equalsIgnoreCase("Unalloted_Student")){
	list= (List<com.Student>)request.getAttribute("data");
...
<div class="page-sidebar-wrapper">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Unalloted Student <small>View</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="StudentAction?jEventName=Unalloted_Student">View Unalloted Student</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Unalloted Student
							</div>
							<div class="actions">
						...
						<div class="portlet-body">
							...
							<%
				        	 ...
				        	 <td><a class='fancybox fancybox.iframe' style="color: purple;" href="LoginServlet?jEventName=Un_Info&ID=<%=list.get(i).getStudentId() %>"><%=list.get(i).getStudentName() %></a></td>
				        	 <td><%=list.get(i).getEmail() %></td>
				        	 <td><%=list.get(i).getPhone() %></td>
				        	 <td><a href="S_Allot.jsp?s_id=<%=list.get(i).getStudentId() %>">Allot</a></td>
				        	 <td><a href="StudentAction?jEventName=Student_Detail&student_id=<%=list.get(i).getStudentId() %>">View Detail</a></td>
				        	 </tr>
				        	 <%
				        	 }
							%>
