...
<%
String ss="View Student Call Back Request";
String dd="";
...
if(jEvent != null && jEvent.equalsIgnoreCase("CallBack")){
	jMessage = (String)request.getAttribute("jMessage");
	al=c2.getCallBack();
}
else if(jEvent != null && jEvent.equalsIgnoreCase("V_CallBack")){
	al = (ArrayList<String>)request.getAttribute("callback");
	dd=(String)request.getAttribute("date");
	ss="View Student Call Back Request By Date";
}
else if(jEvent != null && jEvent.equalsIgnoreCase("All_CallBack")){
	al = (ArrayList<String>)request.getAttribute("callback");
	ss="View All Student Call Back Request";
}
else
{
	al=c2.getCallBack();
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Call Back Request <small>View</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="View_CallBack.jsp">Call Back</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>Call Back
							</div>
							<div class="actions">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								...
								<div class="row">
									<div class="col-md-12">
										...
										<form action="#" method="post" id="contact" name="contact" class="form-horizontal form-bordered">
										<div id="reportrange" class="btn default">
												...
												<input type="button"  class="btn green" onclick="getAllCallBack();" value="View All Call Back Request" /> 
								...
								<div id="callback_loading" style="display: none;">
							...
							<tr>
								...
								<th scope="col">Best Time To Call</th>
							...
							<td><%=i+1 %></td>
							<td><a class='fancybox fancybox.iframe' style="color: purple;" href="LoginServlet?jEventName=C_Info&ID=<%=s2[0]%>"><%=s2[1] %></a></td>
							<td><%=s2[2] %></td>
							<td><%=s2[3] %></td>
							<td><%=s2[4] %></td>
							<td><%=s2[5] %></td>
							...
							<%if(s2[7].equals("n"))
								{
										%>
									<td><a href="LoginServlet?jEventName=CallBack&callback_id=<%=s2[0] %>"><input type="button" name="callback" value="Call Back"></a></td>
								<% 
								}
									else
											{
