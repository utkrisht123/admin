...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			View <small> Student Visited Pages </small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="Student_Visited_Pages.jsp">View Student Visited Pages</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Student Visited Pages
							</div>
	    					...
	    					<div class="table-scrollable">
								<table class="table table-striped table-bordered table-hover" id="sample_3">
									...
									<tbody  id=records_table>
										<tr class="odd gradeX" id=records_table data-ng-repeat="x in student|filter:searchText">	
											<td>{{ $index + 1 }}</td>
											<td>{{ x.Student_id }}</td>
											<td><a class='fancybox fancybox.iframe' style='color: purple;' href='LoginServlet?jEventName={{x.jEventName}}&ID={{x.Student_id}}'>{{ x.Student_Name }}</a></td>
											<td>{{ x.VISITED_PAGE }}</td>
											<td>{{ x.IP_ADDRRESS }}</td>
											<td>{{ x.Email_Id }}</td>
				                          	<td>{{ x.Phone}}</td>
				                          	<td>{{ x.Visited_date}}</td>
			                            </tr>                 
		                            </tbody>       
								</table>
							</div>
...
app.controller('myCtrl', function($scope,$http,$q) {
	...
	var url1="Page_Details?jEventName=student";
