...
if(jEvent != null && jEvent.equalsIgnoreCase("U_ChatQuery")){
	jMessage=(String)request.getAttribute("jMessage");
	
}
else if(jEvent != null && jEvent.equalsIgnoreCase("D_ChatQuery")){
	jMessage=(String)request.getAttribute("jMessage");
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="ViewChatQuery.jsp">View Chat Query</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Chat Query
							</div>
						...
						<div class="row">
							...
							<% 
									...
									%>
							<div id="profile_loading" style="display: none;">
	...
	var d='',d2='';
	   var handleDateRangePickers = function () {
		   $('#reportrange').daterangepicker({
		    	 ...
		    	 $.get("livedemo.do",
		        	    {
		    		 			d: d,
		    		 			d2: d2,
		    		 			course: $('#subject_id').val(),
		             	        jEventName: "ChatQueryByFilter"
		        	    },
		        	    function(data,status){
		        	      //alert("Data: " + data + "\nStatus: " + status);
		        	    	//alert(data);
		     ...
		     var getAllChatQuery=function ()
		     {
		    	 $('#profile_loading').show();
		    	 $.get("livedemo.do",
		        	    {
		             	        jEventName: "ChatQuery"
		        	    },
		        	    function(data,status){
		        	      //alert("Data: " + data + "\nStatus: " + status);
		        	    	//alert(data);
