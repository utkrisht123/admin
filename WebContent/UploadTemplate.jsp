...
String jMessage="";
String url="",title="",description="",id="";
String jEventName="Upload_Template";
if(!(jEvent != null))	
	jEvent = "Intial";
ArrayList<String> al=new ArrayList<String>();
if(jEvent != null && jEvent.equalsIgnoreCase("Upload_Template")){
	jMessage=(String)request.getAttribute("jMessage");
	al=(ArrayList<String>)request.getAttribute("data");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("Edit_Template")){
	id=(String)request.getAttribute("id");
	title=(String)request.getAttribute("title");
	description=(String)request.getAttribute("description");
	url=(String)request.getAttribute("url");
	al=(ArrayList<String>)request.getAttribute("data");
	jEventName="Update_Template";
}
else if(jEvent != null && jEvent.equalsIgnoreCase("Update_Template")){
	jMessage=(String)request.getAttribute("jMessage");
	al=(ArrayList<String>)request.getAttribute("data");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("Delete_Template")){
	jMessage=(String)request.getAttribute("jMessage");
	al=(ArrayList<String>)request.getAttribute("data");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("G_Template")){
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="LoginServlet?jEventName=G_Template">Upload Template</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Upload Template
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							...
							<form action="LoginServlet" method="post" id="form_sample_3" class="form-horizontal">
								<div class="form-body">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Template Title<span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<input type="text" name="title" data-required="1" class="form-control" required="required" value="<%=title%>"/>
										</div>
									</div>
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											...
											<textarea class="form-control" required="required" name="description"><%=description %></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Template URL<span class="required">
										* </span>
										</label>
										<div class="col-md-4">
								...
								<div class="form-actions">
									<div class="row">
										...
										<%
										if(jEvent!=null && jEvent.equalsIgnoreCase("Edit_Template"))
										{
										%>
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						...
						<div class="portlet-body">
							...
							<tr>
								<th>S.No.</th>
								<th>Title</th><th>Description</th><th>URL</th><th>Edit</th><th>Delete</th>
							...
							<td><a  href="LoginServlet?jEventName=Edit_Template&id=<%=s2[0] %>&title=<%=s2[1] %>&description=<%=s2[2] %>&url=<%=s2[3] %>">Edit</a></td>
							<td><a  href="LoginServlet?jEventName=Delete_Template&id=<%=s2[0] %>" onclick="return check();">Delete</a></td>
