...
else if(jEvent != null && jEvent.equalsIgnoreCase("Co_Info")){
			...
			<div class="row">
				<div class="col-md-12">
					...
					<tr>
						...
						<td style="width:45%">Contact Request</td>
					</tr>
					<tr>
						<td>
							 Email
					...
					<tr>
						...
						Next Webinar</td>
						<td>
							<a href="#" id="vacation" data-type="date" data-

format="dd.mm.yyyy" data-pk="1" data-placement="right" data-original-title="Schedule Webinar">
							 </a>
					...
					%>
						...
						<td>
							...
							<a  href="LoginServlet?jEventName=G_BatchDetail&subject=Hadoop&id=<%=id %>&lp_id=<%=lpId %>&cookie_id=<%=cookie_id %>&jevent=contact" id="view_batch"><input type="button" name="b2" class="btn btn-circle blue-madison" value="View Batch Detail"  /></a>
								&nbsp;&nbsp;&nbsp;&nbsp;
...
<script src="scripts/contact_editable.js"></script>
...
var sendSelfEmail=function ()
{
    	...
    	var country=ccc;
    	var name='<%=name %>';
    	window.open("Self_Paced_Email.jsp?name="+name+"&id="+id+"&email="+email+"&country="+country+"&Query_type=Contact Request","_blank");
};
...
var sendInstructorEmail=function ()
{
      	...
      	window.open("InstructorLed_Email.jsp?name="+name+"&id="+id+"&email="+email+"&country="+country+"&interest="+interest_level+"&Query_type=Contact Request","_blank");
};
...
$("#view").change(function(){
	...
	var link="LoginServlet?jEventName=G_BatchDetail&subject="+course+"&id=<%=id %>&lp_id=<%=lpId %>&cookie_id=<%=cookie_id %>&jevent=contact";
