...
<body class="page-header-fixed page-quick-sidebar-over-content" data-ng-app="myApp" data-ng-controller="myCtrl" id=records_table>
<%
...
if(jEvent != null && jEvent.equalsIgnoreCase("entermedia")){
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		...
		Live Demo <small> Search </small>
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						...
						<a href="Live_Demo_search.jsp">Live Demo</a>
						<i class="fa fa-angle-right"></i>
					</li>
				</ul>
			...
			<div class="row">
				...
				<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-search"></i>Live Demo Search
							</div>
							<!-- <div class="tools">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form   id="form_sample_3" class="form-horizontal"  data-ng-submit="submit();">
								<div class="form-body">
								<div class="alert alert-danger display-hide" id="gm" hidden>
									<button class="close" data-close="alert"></button>
										...
										<div class="col-md-4">
											<input type="text" name="media_name" data-required="1" class="form-control" id="media"/>
											<span id="em" style="color:#A94442" hidden>Email ID is required</span>
										</div>
										</div>
			...
			<div class="portlet-body" id="view_table" hidden>
					<div class="row">
						<div class="col-md-12">
							<form action="" method="get"  name="l_demo" id="l_demo" class="form-horizontal form-bordered">
								<div id="sample_2_filter" class="dataTables_filter pull-right" style="margin:10px;">
									<label>
										Search:
    			...
    			<div  id="hero">
    				<div class="table-scrollable">
						<table class="table table-striped table-bordered table-hover" >
							...
							<tbody>
							<tr data-ng-repeat="x in view|filter:searchText">
							<td>{{ $index + 1 }}</td>
							<td>{{x.id}}</td>
							<td><a class='fancybox fancybox.iframe'  href="LoginServlet?jEventName=S_Info&id={{x.query_ID}}&lp_id={{x.LP_ID}}&cookie_id={{x.cookie_id}}&interest={{x.Interest}}">{{x.name}}</a></td>
							<td>{{x.email}}</td>
							<td>{{x.phone}}</td>
							<td>{{x.course}}</td>
							<td>{{x.date_time}}</td>
							<td data-ng-if="x.Attended=='y'">Attended</td>
							<td data-ng-if="x.Attended=='n'">Not Attended</td>
							<td>{{x.pickUp}}</td>
							<td><span star-rating rating-value="x.Interest" max="5"></span></td>
							</tr>
							</tbody>
						</table>
						</div>
...
<div id="loading" class="text-center kk"   style="position:absolute;top:50%" hidden>
...
app.controller('myCtrl', function($scope,$http) {
	 $scope.submit = function() {
		...
		var url2="Page_Details?jEventName=search&email="+email;
			$http.get(url2).success(function(response){
				//console.log(response);
				$scope.view=response.records;
				 $("#em").hide();
				 $("#gm").hide();
				 $("#view_table").show();
				  $("#loading").hide();
