				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Live Demo Phone Number <small>Total Message Left is: </small><span class="label label-sm label-danger" id="sms-left"></span>
							</div>
							<div class="actions">
									...
									<div class="col-md-12">
										...
										&nbsp;&nbsp;&nbsp;
											...
											<select class="form-control input-big input-inline" id="course" name="course" >
												...
												&nbsp;&nbsp;&nbsp;
												<label>
												<input type="button"  class="btn green" id="alllivedemo" value="Export CSV" /> 
											</label>
											</form>
...
jQuery(document).ready(function() {
	/*var myfunc=function(data, success) {
		  alert(data);
		};
		$.ajax({
		  type: "GET",
		  url: "http://api.znisms.com/crinfo/userinfov3.asp?userid=gyansha&apikey=2bf89e9b01000a6572605bccd4f57b83&callback=?",
		  dataType: 'jsonp',
		  async: false,
		  jsonpCallback: function(){alert(xml);}, // the function to call
...
/*
	jQuery.ajax({
		  url: "http://api.znisms.com/crinfo/userinfov3.asp?userid=gyansha&apikey=2bf89e9b01000a6572605bccd4f57b83",
		  type:"GET",
		  dataType:"jsonp",
	   ...
	   var handleDateRangePickers = function () {
		   $('#reportrange').daterangepicker({
		     ...
		     var getCSV=function ()
		     {
		           ...
		           var url="PhoneCSV?d="+d+"&d2="+d2+"&course="+course;
