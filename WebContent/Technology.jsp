...
al=c2.getTechnology();
String technologyId="",technologyName="";
if(jEvent != null && jEvent.equalsIgnoreCase("C_Technology")){
	jMessage = (String)request.getAttribute("jMessage");
	
}
else if(jEvent != null && jEvent.equalsIgnoreCase("E_Technology")){
	jMessage = (String)request.getAttribute("jMessage");
	technologyId = (String)request.getAttribute("technologyId");
	technologyName = (String)request.getAttribute("technologyName");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("U_Technology")){
	jMessage = (String)request.getAttribute("jMessage");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("D_Technology")){
	jMessage = (String)request.getAttribute("jMessage");	
}
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>Create Category
							</div>
						...
						<form action="LoginServlet" method="post" id="form_sample_3" class="form-horizontal">
							<div class="form-body">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Technology Name<span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<input type="text" name="name" id="name"  class="form-control" required="required" value="<%=technologyName %>"  />
										</div>
									</div>
								...
								<div class="form-actions">
									...
									if(jEvent != null && jEvent.equalsIgnoreCase("E_Technology") ){
	
										%>
										<button type="submit" class="btn green">Update</button>
										<input type="hidden" name="jEventName" value="U_Technology" />
											<input type="hidden" name="id" value="<%=technologyId%>" />
											<input type="hidden" name="old_name" value="<%=technologyName%>" />
										<%
											}
									else
									{
										...
										<input type="hidden" name="jEventName" value="C_Technology" />
										<%
									}
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box yellow">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>View Technology
							</div>
						...
						<div id="detail_loading" style="display: none;">
							...
							<tr>
								...
								<th scope="col">Technology Name</th><th scope="col">Edit</th><th scope="col">Delete</th>
							...
							<tr class="odd gradeX">
								...
								<td><%=i+1 %></td>
								<td><%=s2[1] %></td>
								<td><a  href="LoginServlet?jEventName=E_Technology&id=<%=s2[0] %>&name=<%=s2[1] %>">Edit</a></td>
								<td><a  href="LoginServlet?jEventName=D_Technology&id=<%=s2[0] %>" onclick="return check();">Delete</a></td>
