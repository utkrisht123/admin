<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
       <%@ page import="java.util.*" %>
        <jsp:useBean id="c2" class="com.TeacherDAO"></jsp:useBean>
<!DOCTYPE html>
<!-- 
...
String jMessage =  null;
	...
	List<com.Teacher> list3 = new ArrayList<com.Teacher>();
	list3=(List<com.Teacher>)request.getAttribute("data");
	if(jEvent != null && jEvent.equalsIgnoreCase("U_T_Profile")){
		jMessage = (String)request.getAttribute("jMessage");
	}

	else if(jEvent != null && jEvent.equalsIgnoreCase("D_T_Batch")){
			jMessage = (String)request.getAttribute("jMessage");
	...
	if(sex!=null && sex.equalsIgnoreCase("Male"))
		...
		m2="selected";
//System.out.println("jMessage: "+jMessage);
%>
<!-- BEGIN HEADER -->
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="TeacherAction?jEventName=Teacher_Detail&teacher_id=<%=teacherId%>">Teacher Detail</a>
					</li>
				</ul>
						...
						<div class="portlet light bordered">
									...
									<div class="portlet-title">
										<div class="caption">
											...
											<span class="caption-subject font-blue-hoki bold uppercase">Teacher Info</span>
									...
									<div class="portlet-body form">
										...
										<form action="#" class="horizontal-form">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" id="t_name" name="t_name" class="form-control" value="<%=teacherName%>">
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" id="f_name" name="f_name" class="form-control" value="<%=fatherName%>">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="hidden" id="old_email" name="old_email" class="form-control" value="<%=email%>">
														</div>
													</div>
													<!--/span-->
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" id="phone" name="phone" class="form-control" value="<%=mobile%>">
														</div>
													</div>
													<!--/span-->
												</div>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<select class="form-control" id="sex" name="sex">
																...
																<option value="Male" <%=m1 %>>Male</option>
																<option value="Female" <%=m2 %>>Female</option>
															</select>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" id="dob" name="dob" class="form-control form-control-inline input-medium date-picker" value="<%=dob%>" >
														</div>
													</div>
													<!--/span-->
												</div>
											...
											<div class="form-actions right">
												...
												<button type="submit" class="btn blue" ><i class="fa fa-check"></i> Update Profile</button>
												<button type="button" class="btn green" id="allotbatch">Allot Batch</button>
											</div>
											<input type="hidden" name="t_id" id="t_id" value="<%=teacherId %>" />
											<input type="hidden" name="jEventName" value="U_T_Profile" />
										</form>
										<!-- END FORM-->
									</div>
								</div>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>Alloted Teacher Batches
							</div>
							<div class="actions">
						...
						<div class="portlet-body">
							...
							<tr>
								...
								<th scope="col">Delete Alloted Batch</th>
							</tr>
							</thead>
							<tbody>
							<%
							...
							<tr class="odd gradeX">
							<td><%=i+1 %></td>
							<td><%=list3.get(i).getSubjectName() %></td>
							<td><%=list3.get(i).getBatch() %></td>
							<td><%=list3.get(i).getStartDate() %></td>
							<td><%=list3.get(i).getStartTime() %></td>
							<td><%=list3.get(i).getBatchType() %></td>
							
							<td><a href="TeacherAction?jEventName=D_T_Batch&t_id=<%=teacherId %>&batch=<%=list3.get(i).getBatch() %>" onclick="return check();">Delete</a></td>
						</tr>
							<%
							}
								%>
...
$("#allotbatch").click(function(){
	var id='<%=teacherId%>';
    location.replace("T_Allot.jsp?t_id="+id);
});
function check()
{
	var c=confirm("Are you sure to delete alloted batch ?");
	if(c)
		return true;
	else 
		return false;
