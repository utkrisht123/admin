<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
     <jsp:useBean id="c2" class="com.ActionServlet"></jsp:useBean>
...
<head>
<meta charset="utf-8"/>
<title>GyanSha Infotech | SEO</title>
								...
								<div class="row">
									...
									<div class="col-md-7">
										<div class="scroller" style="max-height: 600px;" data-always-visible="0" data-rail-visible="0" data-handle-color="#dae3e7">
											<form action="ServletAction" class="form-horizontal">
												<!-- TASK HEAD -->
												<div class="form">
													<div class="form-group">
														<div class="col-md-8 col-sm-8">
															<div class="todo-taskbody-user">
																...
																<span class="todo-username pull-left"><%=session.getAttribute("user") %></span>
													...
													<!-- END TASK HEAD -->
													<!-- TASK TITLE -->
													<%if(jEvent != null && jEvent.equalsIgnoreCase("C_Task")){
													...
													<div class="form-group">
														<div class="col-md-12">
															<input type="text" class="form-control todo-taskbody-tasktitle" placeholder="Task Title..." name="title" required="required">
														</div>
													</div>
													<!-- TASK DESC -->
													<div class="form-group">
														<div class="col-md-12">
															<textarea class="form-control todo-taskbody-taskdesc" rows="8" placeholder="Task Description..." name="description" required="required"></textarea>
														</div>
													</div>
													<!-- END TASK DESC -->
													<!-- TASK DUE DATE -->
													...
													<div class="form-group">
													<label class="control-label col-md-4">From Date Time</label>
														<div class="col-md-8">
																<div class="input-group date form_datetime" >
																	<input type="text" size="16" name="from" required="required" readonly class="form-control">
													...
													<div class="form-group">
													<label class="control-label col-md-4">To Date Time</label>
														<div class="col-md-8">
																<div class="input-group date form_datetime" >
																<input type="text" size="16" name="to" required="required" readonly class="form-control">
																<span class="input-group-btn">
																<button class="btn default date-reset" type="button"><i class="fa fa-times"></i></button>
																</span>
																<span class="input-group-btn">
													...
													<div class="form-group">
														<div class="col-md-12">
															<input type="text" class="form-control todo-taskbody-tags" placeholder="Tags..." value="Requested" name="status" required="required">
														</div>
													</div>
													<!-- TASK TAGS -->
													<div class="form-actions right todo-form-actions">
														...
														<input type="hidden"  value="C_Task" name="jEventName">
													</div>
												</div>
													...
													<div class="tab-content">
														...
														<div class="tab-pane active" id="tab_1">
															...
															ArrayList<String> al3=new ArrayList<String>();
																	al3=c2.getLastHistoryTask(user);
											...
											%>
												<div class="todo-tasklist-item todo-tasklist-item-border-green">
													...
													<div class="todo-tasklist-controls pull-left">
														<span class="todo-tasklist-date">From: <i class="fa fa-calendar"></i> <%=s2[3] %> </span>
														<span class="todo-tasklist-date">To: <i class="fa fa-calendar"></i> <%=s2[4] %> </span>
														<span class="todo-tasklist-badge badge badge-roundless"><%=s2[2] %></span>
													</div>
												</div>
												<%} %>
