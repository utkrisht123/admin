    ...
    pageEncoding="ISO-8859-1"%>
      <jsp:useBean id="c2" class="com.LiveDemoDAO"></jsp:useBean>
       <%@ page import="java.util.*" %>
        <jsp:useBean id="c" class="com.AdminServlet"></jsp:useBean>
...
if(jEvent != null && jEvent.equalsIgnoreCase("V_CONTACT")){
	al = (ArrayList<String>)request.getAttribute("contact");
	dd=(String)request.getAttribute("date");
	dd2=(String)request.getAttribute("date2");
	ss="View All Student Contact Request By Date";
	
}
else if(jEvent != null && jEvent.equalsIgnoreCase("N_Contact")){
	al = (ArrayList<String>)request.getAttribute("contact");
	f="notification";
	ss="View Student Contact Request Notification";
}
else if(jEvent != null && jEvent.equalsIgnoreCase("R_Contact")){
	al = (ArrayList<String>)request.getAttribute("contact");
	jMessage=(String)request.getAttribute("jMessage");
}
else if(jEvent != null && jEvent.equalsIgnoreCase("All_C_Request")){
	al = (ArrayList<String>)request.getAttribute("contact");
	ss="View All Student Contact Request";
}
else
{
	al=c.getContact();
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Contact Request <small>View</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="V_Contact.jsp">Contact Request</a>
					</li>
				</ul>
					...
					<div class="portlet box yellow">
						...
						%>
										...
										<div id="reportrange" class="btn default">
												...
												<input type="button"  class="btn green" onclick="getAllContact();" value="Search All Contact Request" /> 
								...
								<div id="contact_loading" style="display: none;">
								<img src="img/loading.gif" alt="loading"/>
							</div>
							<% 
									if(jEvent != null && jEvent.equalsIgnoreCase("R_Contact")){
							...
							<tr>
							<%
							if(f.equals("notification") && !al.isEmpty())
								{
%>
								...
								<th scope="col">Send Custom Email</th>
							</tr>
							</thead>
							<tbody>
							<%
							...
							<%
								if(f.equals("notification") && !al.isEmpty())
									...
									%>
								<td>
									<input type="checkbox" name="c" class="checkboxes" value="<%=s2[0] %>"/>
								</td>
								<%} %>
								<td><%=i+1 %></td>
								<td><a class='fancybox fancybox.iframe' style="color: purple;" href="LoginServlet?jEventName=Co_Info&ID=<%=s2[0] %>"><%=s2[1] %></a></td>
								<td><%=s2[2] %></td>
								<td><%=s2[3] %></td>
								<td><%=s2[4] %></td>
								<td><%=s2[5] %></td>
								...
								<td>
									...
									<a href="Send_Custom_Email.jsp?name=<%=s2[1] %>&email=<%=s2[3] %>&phone=<%=s2[2] %>&country=IN&id=0&student_id= &interest_level=0">Send Custom Email</a> 
								</td>
							</tr>
							<%} %>
							</tbody>
							...
							<input type="hidden" name="jEventName" value="R_Contact">
							</form>
							</div>
							</div>
