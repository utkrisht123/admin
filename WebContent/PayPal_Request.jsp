...
if(jEvent != null && jEvent.equalsIgnoreCase("PayPal_Request")){
...
<div class="page-sidebar-wrapper">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			PayPal Payment<small> View Request Only</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="PaymentServlet?jEventName=PayPal_Request">PayPal Payment Request Only</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>PayPal Payment Request Only
							</div>
